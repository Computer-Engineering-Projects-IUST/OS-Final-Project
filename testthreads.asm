...
main(int argc, char *argv[])
{
  ...
  lock_init(lk) ; 
  11:	ff 35 68 0c 00 00    	push   0xc68
  17:	e8 74 03 00 00       	call   390 <lock_init>
  printf(1, "test executing threads with lock :\n");
  1c:	58                   	pop    %eax
  1d:	5a                   	pop    %edx
  1e:	68 80 08 00 00       	push   $0x880
  23:	6a 01                	push   $0x1
  25:	e8 16 05 00 00       	call   540 <printf>
  int arg1 = 9, arg2 = 1 ; 
  thread_create(&add, (void *)&arg1, (void *)&arg2);
  2a:	83 c4 0c             	add    $0xc,%esp
  2d:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  int arg1 = 9, arg2 = 1 ; 
  30:	c7 45 e0 09 00 00 00 	movl   $0x9,-0x20(%ebp)
  thread_create(&add, (void *)&arg1, (void *)&arg2);
  37:	50                   	push   %eax
  38:	8d 45 e0             	lea    -0x20(%ebp),%eax
  3b:	50                   	push   %eax
  3c:	68 b0 00 00 00       	push   $0xb0
  int arg1 = 9, arg2 = 1 ; 
  41:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%ebp)
  thread_create(&add, (void *)&arg1, (void *)&arg2);
  48:	e8 f3 02 00 00       	call   340 <thread_create>
  int arg3 = 4 , arg4 = 2;
  thread_create(&add, (void *)&arg3, (void *)&arg4);
  4d:	83 c4 0c             	add    $0xc,%esp
  50:	8d 45 ec             	lea    -0x14(%ebp),%eax
  int arg3 = 4 , arg4 = 2;
  53:	c7 45 e8 04 00 00 00 	movl   $0x4,-0x18(%ebp)
  thread_create(&add, (void *)&arg3, (void *)&arg4);
  5a:	50                   	push   %eax
  5b:	8d 45 e8             	lea    -0x18(%ebp),%eax
  5e:	50                   	push   %eax
  5f:	68 b0 00 00 00       	push   $0xb0
  int arg3 = 4 , arg4 = 2;
  64:	c7 45 ec 02 00 00 00 	movl   $0x2,-0x14(%ebp)
  thread_create(&add, (void *)&arg3, (void *)&arg4);
  6b:	e8 d0 02 00 00       	call   340 <thread_create>
  int arg5 = 7 ,  arg6 = 4;
  thread_create(&add, (void *)&arg5, (void *)&arg6);
  70:	83 c4 0c             	add    $0xc,%esp
  73:	8d 45 f4             	lea    -0xc(%ebp),%eax
  int arg5 = 7 ,  arg6 = 4;
  76:	c7 45 f0 07 00 00 00 	movl   $0x7,-0x10(%ebp)
  thread_create(&add, (void *)&arg5, (void *)&arg6);
  7d:	50                   	push   %eax
  7e:	8d 45 f0             	lea    -0x10(%ebp),%eax
  81:	50                   	push   %eax
  82:	68 b0 00 00 00       	push   $0xb0
  int arg5 = 7 ,  arg6 = 4;
  87:	c7 45 f4 04 00 00 00 	movl   $0x4,-0xc(%ebp)
  thread_create(&add, (void *)&arg5, (void *)&arg6);
  8e:	e8 ad 02 00 00       	call   340 <thread_create>
  thread_join();
  93:	e8 d8 02 00 00       	call   370 <thread_join>
  thread_join();
  98:	e8 d3 02 00 00       	call   370 <thread_join>
  thread_join();
  9d:	e8 ce 02 00 00       	call   370 <thread_join>
  exit() ; 
  a2:	e8 2e 03 00 00       	call   3d5 <exit>
  a7:	66 90                	xchg   %ax,%ax
  a9:	66 90                	xchg   %ax,%ax
  ab:	66 90                	xchg   %ax,%ax
  ad:	66 90                	xchg   %ax,%ax
...
void add(void* arg1, void* arg2) {
  ...
  lock_acquire(lk);
  b6:	ff 35 68 0c 00 00    	push   0xc68
  bc:	e8 df 02 00 00       	call   3a0 <lock_acquire>
  ...
  lock_release(lk); 
  db:	58                   	pop    %eax
  dc:	ff 35 68 0c 00 00    	push   0xc68
  e2:	e8 d9 02 00 00       	call   3c0 <lock_release>
  exit();
  e7:	e8 e9 02 00 00       	call   3d5 <exit>
  ec:	66 90                	xchg   %ax,%ax
  ee:	66 90                	xchg   %ax,%ax
 ...
 49c:	89 d1                	mov    %edx,%ecx
{
 ...
 4c9:	0f b6 92 04 09 00 00 	movzbl 0x904(%edx),%edx
 ...
 549:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b9:	ff 24 85 ac 08 00 00 	jmp    *0x8ac(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6c7:	90                   	nop
          s = "(null)";
 6c8:	ba a4 08 00 00       	mov    $0x8a4,%edx
        while(*s != 0){
