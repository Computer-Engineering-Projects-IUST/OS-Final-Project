...
8010021b:	e8 c0 47 00 00       	call   801049e0 <acquire>
  b->refcnt--;
...
8010026b:	5d                   	pop    %ebp
  release(&bcache.lock);
8010026c:	e9 0f 47 00 00       	jmp    80104980 <release>
    panic("brelse");
...
801002a0:	e8 3b 47 00 00       	call   801049e0 <acquire>
  while(n > 0){
...
801002cd:	e8 ae 41 00 00       	call   80104480 <sleep>
    while(input.r == input.w){
...
80100551:	e8 ea 45 00 00       	call   80104b40 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100566:	e8 35 45 00 00       	call   80104aa0 <memset>
  outb(CRTPORT+1, pos);
...
801005ab:	e8 30 44 00 00       	call   801049e0 <acquire>
  for(i = 0; i < n; i++)
...
801005e4:	e8 97 43 00 00       	call   80104980 <release>
  ilock(ip);
801005e9:	58                   	pop    %eax
...
801007e8:	e8 f3 41 00 00       	call   801049e0 <acquire>
...
8010085b:	e8 20 41 00 00       	call   80104980 <release>
...
80100893:	e8 48 41 00 00       	call   801049e0 <acquire>
  while((c = getc()) >= 0){
...
801009d0:	e8 ab 3f 00 00       	call   80104980 <release>
  if(doprocdump) {
...
80100a0e:	e9 0d 3c 00 00       	jmp    80104620 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
...
80100a44:	e8 f7 3a 00 00       	call   80104540 <wakeup>
...
80100a70:	e8 9b 3d 00 00       	call   80104810 <initlock>
...
80100cd3:	e8 c8 3f 00 00       	call   80104ca0 <strlen>
...
80100ce4:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100ce7:	e8 b4 3f 00 00       	call   80104ca0 <strlen>
...
80100da1:	e8 ba 3e 00 00       	call   80104c60 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100e20:	e8 eb 39 00 00       	call   80104810 <initlock>
}
...
80100e41:	e8 9a 3b 00 00       	call   801049e0 <acquire>
...
80100e71:	e8 0a 3b 00 00       	call   80104980 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e8a:	e8 f1 3a 00 00       	call   80104980 <release>
}
...
80100eaf:	e8 2c 3b 00 00       	call   801049e0 <acquire>
  if(f->ref < 1)
...
80100ecc:	e8 af 3a 00 00       	call   80104980 <release>
  return f;
}
...
80100f01:	e8 da 3a 00 00       	call   801049e0 <acquire>
  if(f->ref < 1)
...
80100f39:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f3c:	e8 3f 3a 00 00       	call   80104980 <release>
...
80100f6d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f6e:	e9 0d 3a 00 00       	jmp    80104980 <release>
...
80101325:	e8 76 37 00 00       	call   80104aa0 <memset>
  log_write(bp);
...
8010136a:	e8 71 36 00 00       	call   801049e0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013d7:	e8 a4 35 00 00       	call   80104980 <release>
...
80101402:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101405:	e8 76 35 00 00       	call   80104980 <release>
      return ip;
...
80101541:	e8 fa 35 00 00       	call   80104b40 <memmove>
  brelse(bp);
...
80101576:	e8 95 32 00 00       	call   80104810 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 4c 31 00 00       	call   801046e0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 7f 35 00 00       	call   80104b40 <memmove>
  brelse(bp);
...
8010168e:	e8 0d 34 00 00       	call   80104aa0 <memset>
      dip->type = type;
...
80101731:	e8 0a 34 00 00       	call   80104b40 <memmove>
  log_write(bp);
...
8010175f:	e8 7c 32 00 00       	call   801049e0 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010176f:	e8 0c 32 00 00       	call   80104980 <release>
}
...
801017a2:	e8 79 2f 00 00       	call   80104720 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 23 33 00 00       	call   80104b40 <memmove>
    brelse(bp);
...
80101873:	e8 48 2f 00 00       	call   801047c0 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 ec 2e 00 00       	jmp    80104780 <releasesleep>
    panic("iunlock");
...
801018c0:	e8 5b 2e 00 00       	call   80104720 <acquiresleep>
...
801018da:	e8 a1 2e 00 00       	call   80104780 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
801018e6:	e8 f5 30 00 00       	call   801049e0 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 7b 30 00 00       	jmp    80104980 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 09 11 80       	push   $0x80110960
80101910:	e8 cb 30 00 00       	call   801049e0 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010191f:	e8 5c 30 00 00       	call   80104980 <release>
    if(r == 1){
...
80101a23:	e8 98 2d 00 00       	call   801047c0 <holdingsleep>
...
80101a3a:	e8 41 2d 00 00       	call   80104780 <releasesleep>
  iput(ip);
...
80101b37:	e8 04 30 00 00       	call   80104b40 <memmove>
    brelse(bp);
...
80101c33:	e8 08 2f 00 00       	call   80104b40 <memmove>
    log_write(bp);
...
80101cce:	e8 dd 2e 00 00       	call   80104bb0 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 7e 2e 00 00       	call   80104bb0 <strncmp>
      continue;
...
80101dba:	e8 21 2c 00 00       	call   801049e0 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
80101dca:	e8 b1 2b 00 00       	call   80104980 <release>
...
80101e27:	e8 14 2d 00 00       	call   80104b40 <memmove>
...
80101e8c:	e8 2f 29 00 00       	call   801047c0 <holdingsleep>
...
80101eae:	e8 cd 28 00 00       	call   80104780 <releasesleep>
  iput(ip);
...
80101edb:	e8 60 2c 00 00       	call   80104b40 <memmove>
    name[len] = 0;
...
80101f2b:	e8 90 28 00 00       	call   801047c0 <holdingsleep>
...
80101f4a:	e8 31 28 00 00       	call   80104780 <releasesleep>
  iput(ip);
...
80101f6d:	e8 4e 28 00 00       	call   801047c0 <holdingsleep>
...
80101f90:	e8 2b 28 00 00       	call   801047c0 <holdingsleep>
...
80101fa7:	e8 d4 27 00 00       	call   80104780 <releasesleep>
}
...
8010203d:	e8 be 2b 00 00       	call   80104c00 <strncpy>
...
801021d0:	e8 3b 26 00 00       	call   80104810 <initlock>
...
8010224e:	e8 8d 27 00 00       	call   801049e0 <acquire>
...
801022ad:	e8 8e 22 00 00       	call   80104540 <wakeup>
...
801022cb:	e8 b0 26 00 00       	call   80104980 <release>
...
801022ee:	e8 cd 24 00 00       	call   801047c0 <holdingsleep>
...
80102328:	e8 b3 26 00 00       	call   801049e0 <acquire>
...
80102369:	e8 12 21 00 00       	call   80104480 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 f5 25 00 00       	jmp    80104980 <release>
...
801024f2:	e8 a9 25 00 00       	call   80104aa0 <memset>
...
80102528:	e8 b3 24 00 00       	call   801049e0 <acquire>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 38 24 00 00       	jmp    80104980 <release>
    panic("kfree");
...
80102625:	e8 e6 21 00 00       	call   80104810 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 28 23 00 00       	call   801049e0 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 9a 22 00 00       	call   80104980 <release>
  return (char*)r;
...
80102af7:	e8 f4 1f 00 00       	call   80104af0 <memcmp>
...
80102c24:	e8 17 1f 00 00       	call   80104b40 <memmove>
...
80102cd4:	e8 37 1b 00 00       	call   80104810 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 70 1c 00 00       	call   801049e0 <acquire>
...
80102d85:	e8 f6 16 00 00       	call   80104480 <sleep>
...
80102dbc:	e8 bf 1b 00 00       	call   80104980 <release>
      break;
    }
  }
}
...
80102dde:	e8 fd 1b 00 00       	call   801049e0 <acquire>
  log.outstanding -= 1;
...
80102e1c:	e8 5f 1b 00 00       	call   80104980 <release>
}
...
80102e36:	e8 a5 1b 00 00       	call   801049e0 <acquire>
    wakeup(&log);
...
80102e49:	00 00 00 
    wakeup(&log);
80102e4c:	e8 ef 16 00 00       	call   80104540 <wakeup>
    release(&log.lock);
80102e51:	c7 04 24 a0 26 11 80 	movl   $0x801126a0,(%esp)
80102e58:	e8 23 1b 00 00       	call   80104980 <release>
...
80102eb4:	e8 87 1c 00 00       	call   80104b40 <memmove>
...
80102f08:	e8 33 16 00 00       	call   80104540 <wakeup>
  release(&log.lock);
80102f0d:	c7 04 24 a0 26 11 80 	movl   $0x801126a0,(%esp)
80102f14:	e8 67 1a 00 00       	call   80104980 <release>
...
80102f76:	e8 65 1a 00 00       	call   801049e0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 c6 19 00 00       	jmp    80104980 <release>
...
801030d4:	e8 67 1a 00 00       	call   80104b40 <memmove>
...
801031c4:	e8 27 19 00 00       	call   80104af0 <memcmp>
...
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 6c 18 00 00       	call   80104af0 <memcmp>
...
801033c8:	e8 23 17 00 00       	call   80104af0 <memcmp>
...
801034a9:	e8 62 13 00 00       	call   80104810 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 9c 14 00 00       	call   801049e0 <acquire>
  if(writable){
...
8010355f:	e8 dc 0f 00 00       	call   80104540 <wakeup>
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 f7 13 00 00       	jmp    80104980 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 e7 13 00 00       	call   80104980 <release>
    kfree((char*)p);
...
801035c4:	e8 77 0f 00 00       	call   80104540 <wakeup>
...
801035dd:	e8 fe 13 00 00       	call   801049e0 <acquire>
  for(i = 0; i < n; i++){
...
80103638:	e8 03 0f 00 00       	call   80104540 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010363d:	58                   	pop    %eax
8010363e:	5a                   	pop    %edx
...
8010366c:	e8 0f 13 00 00       	call   80104980 <release>
        return -1;
...
801036ba:	e8 81 0e 00 00       	call   80104540 <wakeup>
  release(&p->lock);
...
801036e6:	e8 f5 12 00 00       	call   801049e0 <acquire>
...
80103776:	e8 c5 0d 00 00       	call   80104540 <wakeup>
  release(&p->lock);
8010377b:	89 34 24             	mov    %esi,(%esp)
8010377e:	e8 fd 11 00 00       	call   80104980 <release>
  return i;
...
80103799:	e8 e2 11 00 00       	call   80104980 <release>
      return -1;
...
801037c1:	e8 1a 12 00 00       	call   801049e0 <acquire>
...
801037dc:	74 7a                	je     80103858 <allocproc+0xa8>
    if(p->state == UNUSED)
801037de:	8b 43 10             	mov    0x10(%ebx),%eax
...
801037ea:	83 ec 0c             	sub    $0xc,%esp
  p->state = EMBRYO;
801037ed:	c7 43 10 01 00 00 00 	movl   $0x1,0x10(%ebx)
  p->pid = nextpid++;
801037f4:	89 43 14             	mov    %eax,0x14(%ebx)
...
801037ff:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
80103805:	e8 76 11 00 00       	call   80104980 <release>
...
80103822:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103827:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
8010382a:	c7 40 14 36 5d 10 80 	movl   $0x80105d36,0x14(%eax)
  p->context = (struct context*)sp;
80103831:	89 43 20             	mov    %eax,0x20(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103834:	6a 14                	push   $0x14
80103836:	6a 00                	push   $0x0
80103838:	50                   	push   %eax
80103839:	e8 62 12 00 00       	call   80104aa0 <memset>
  p->context->eip = (uint)forkret;
8010383e:	8b 43 20             	mov    0x20(%ebx),%eax
...
80103862:	e8 19 11 00 00       	call   80104980 <release>
}
...
80103870:	c3                   	ret    
    p->state = UNUSED;
80103871:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return 0;
...
8010389b:	e8 e0 10 00 00       	call   80104980 <release>
...
801038e6:	68 c0 7b 10 80       	push   $0x80107bc0
...
80103984:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103987:	e8 04 0f 00 00       	call   80104890 <pushcli>
  c = mycpu();
8010398c:	e8 6f ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103991:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103997:	e8 44 0f 00 00       	call   801048e0 <popcli>
}
...
801039c3:	e8 68 39 00 00       	call   80107330 <setupkvm>
...
801039e1:	e8 fa 35 00 00       	call   80106fe0 <inituvm>
...
801039f6:	e8 a5 10 00 00       	call   80104aa0 <memset>
...
80103a4f:	68 f0 7b 10 80       	push   $0x80107bf0
80103a54:	50                   	push   %eax
80103a55:	e8 06 12 00 00       	call   80104c60 <safestrcpy>
  p->cwd = namei("/");
80103a5a:	c7 04 24 f9 7b 10 80 	movl   $0x80107bf9,(%esp)
...
80103a70:	e8 6b 0f 00 00       	call   801049e0 <acquire>
  p->state = RUNNABLE;
...
80103a93:	68 d7 7b 10 80       	push   $0x80107bd7
...
80103aa5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103aa8:	e8 e3 0d 00 00       	call   80104890 <pushcli>
  c = mycpu();
80103aad:	e8 4e fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ab2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ab8:	e8 23 0e 00 00       	call   801048e0 <popcli>
  sz = curproc->sz;
...
80103acb:	e8 00 34 00 00       	call   80106ed0 <switchuvm>
  return 0;
...
80103aea:	e8 61 36 00 00       	call   80107150 <allocuvm>
...
80103b0a:	e8 71 37 00 00       	call   80107280 <deallocuvm>
...
80103b26:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b29:	e8 62 0d 00 00       	call   80104890 <pushcli>
  c = mycpu();
80103b2e:	e8 cd fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103b33:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b39:	e8 a2 0d 00 00       	call   801048e0 <popcli>
  if((np = allocproc()) == 0){
...
80103b58:	e8 c3 38 00 00       	call   80107420 <copyuvm>
...
80103bd1:	e8 8a 10 00 00       	call   80104c60 <safestrcpy>
  pid = np->pid;
80103bd6:	8b 5f 14             	mov    0x14(%edi),%ebx
  acquire(&ptable.lock);
80103bd9:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103be0:	e8 fb 0d 00 00       	call   801049e0 <acquire>
  np->state = RUNNABLE;
...
80103c46:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103c49:	e8 42 0c 00 00       	call   80104890 <pushcli>
  c = mycpu();
...
80103c59:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  popcli();
80103c5c:	e8 7f 0c 00 00       	call   801048e0 <popcli>
  if((np = allocproc()) == 0)
...
80103d31:	e8 2a 0f 00 00       	call   80104c60 <safestrcpy>
  acquire(&ptable.lock);
80103d36:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d3d:	e8 9e 0c 00 00       	call   801049e0 <acquire>
  p -> childCount++;
...
80103d5a:	e8 21 0c 00 00       	call   80104980 <release>
  return np->pid;
...
80103d99:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){  
80103d9c:	be 54 2d 11 80       	mov    $0x80112d54,%esi
    acquire(&ptable.lock);
80103da1:	68 20 2d 11 80       	push   $0x80112d20
80103da6:	e8 35 0c 00 00       	call   801049e0 <acquire>
80103dab:	83 c4 10             	add    $0x10,%esp
80103dae:	e9 89 00 00 00       	jmp    80103e3c <scheduler+0xbc>
80103db3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103db7:	90                   	nop
      if((p->state != RUNNABLE && !(p->state == SLEEPING  && p->childCount>0 )) || p->IsThread == 1 )
80103db8:	83 f8 02             	cmp    $0x2,%eax
80103dbb:	75 6d                	jne    80103e2a <scheduler+0xaa>
80103dbd:	8b 9e 80 00 00 00    	mov    0x80(%esi),%ebx
80103dc3:	85 db                	test   %ebx,%ebx
80103dc5:	7e 63                	jle    80103e2a <scheduler+0xaa>
80103dc7:	83 be 88 00 00 00 01 	cmpl   $0x1,0x88(%esi)
80103dce:	74 5a                	je     80103e2a <scheduler+0xaa>
      if ( p->childCount != 0 &&  p->turn == 0)
80103dd0:	8b 96 84 00 00 00    	mov    0x84(%esi),%edx
80103dd6:	85 d2                	test   %edx,%edx
80103dd8:	0f 84 22 01 00 00    	je     80103f00 <scheduler+0x180>
        struct cpu *c = mycpu();
80103dde:	e8 1d fb ff ff       	call   80103900 <mycpu>
        switchuvm(p);
80103de3:	83 ec 0c             	sub    $0xc,%esp
        c->proc=p;
80103de6:	89 b0 ac 00 00 00    	mov    %esi,0xac(%eax)
        struct cpu *c = mycpu();
80103dec:	89 c3                	mov    %eax,%ebx
        switchuvm(p);
80103dee:	56                   	push   %esi
80103def:	e8 dc 30 00 00       	call   80106ed0 <switchuvm>
        cprintf("process :%d \n" , p->pid ); 
80103df4:	59                   	pop    %ecx
80103df5:	5f                   	pop    %edi
80103df6:	ff 76 14             	push   0x14(%esi)
80103df9:	68 fb 7b 10 80       	push   $0x80107bfb
        p->state = RUNNING;
80103dfe:	c7 46 10 04 00 00 00 	movl   $0x4,0x10(%esi)
        cprintf("process :%d \n" , p->pid ); 
80103e05:	e8 96 c8 ff ff       	call   801006a0 <cprintf>
        swtch(&(c->scheduler), p->context);
80103e0a:	58                   	pop    %eax
80103e0b:	8d 43 04             	lea    0x4(%ebx),%eax
80103e0e:	5a                   	pop    %edx
80103e0f:	ff 76 20             	push   0x20(%esi)
80103e12:	50                   	push   %eax
80103e13:	e8 a3 0e 00 00       	call   80104cbb <swtch>
        switchkvm();
80103e18:	e8 a3 30 00 00       	call   80106ec0 <switchkvm>
        c->proc = 0;
80103e1d:	83 c4 10             	add    $0x10,%esp
80103e20:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103e27:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){  
80103e2a:	81 c6 8c 00 00 00    	add    $0x8c,%esi
80103e30:	81 fe 54 50 11 80    	cmp    $0x80115054,%esi
80103e36:	0f 84 a7 00 00 00    	je     80103ee3 <scheduler+0x163>
      if((p->state != RUNNABLE && !(p->state == SLEEPING  && p->childCount>0 )) || p->IsThread == 1 )
80103e3c:	8b 46 10             	mov    0x10(%esi),%eax
80103e3f:	83 f8 03             	cmp    $0x3,%eax
80103e42:	0f 85 70 ff ff ff    	jne    80103db8 <scheduler+0x38>
80103e48:	83 be 88 00 00 00 01 	cmpl   $0x1,0x88(%esi)
80103e4f:	74 d9                	je     80103e2a <scheduler+0xaa>
      if ( p->childCount != 0 &&  p->turn == 0)
80103e51:	8b 8e 80 00 00 00    	mov    0x80(%esi),%ecx
80103e57:	85 c9                	test   %ecx,%ecx
80103e59:	74 83                	je     80103dde <scheduler+0x5e>
80103e5b:	8b 86 84 00 00 00    	mov    0x84(%esi),%eax
80103e61:	85 c0                	test   %eax,%eax
80103e63:	0f 85 75 ff ff ff    	jne    80103dde <scheduler+0x5e>
          struct cpu *c = mycpu();
80103e69:	e8 92 fa ff ff       	call   80103900 <mycpu>
          switchuvm(p);
80103e6e:	83 ec 0c             	sub    $0xc,%esp
          c->proc=p;
80103e71:	89 b0 ac 00 00 00    	mov    %esi,0xac(%eax)
          struct cpu *c = mycpu();
80103e77:	89 c3                	mov    %eax,%ebx
          switchuvm(p);
80103e79:	56                   	push   %esi
80103e7a:	e8 51 30 00 00       	call   80106ed0 <switchuvm>
          cprintf("process :%d \n" , p->pid ); 
80103e7f:	59                   	pop    %ecx
80103e80:	5f                   	pop    %edi
80103e81:	ff 76 14             	push   0x14(%esi)
80103e84:	68 fb 7b 10 80       	push   $0x80107bfb
          p->state = RUNNING;
80103e89:	c7 46 10 04 00 00 00 	movl   $0x4,0x10(%esi)
          cprintf("process :%d \n" , p->pid ); 
80103e90:	e8 0b c8 ff ff       	call   801006a0 <cprintf>
          swtch(&(c->scheduler), p->context);
80103e95:	58                   	pop    %eax
80103e96:	8d 43 04             	lea    0x4(%ebx),%eax
80103e99:	5a                   	pop    %edx
80103e9a:	ff 76 20             	push   0x20(%esi)
80103e9d:	50                   	push   %eax
80103e9e:	e8 18 0e 00 00       	call   80104cbb <swtch>
          switchkvm();
80103ea3:	e8 18 30 00 00       	call   80106ec0 <switchkvm>
        if ( p->turn != 0 )
80103ea8:	83 c4 10             	add    $0x10,%esp
          c->proc = 0;
80103eab:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103eb2:	00 00 00 
        if ( p->turn != 0 )
80103eb5:	8b 86 84 00 00 00    	mov    0x84(%esi),%eax
80103ebb:	85 c0                	test   %eax,%eax
80103ebd:	75 50                	jne    80103f0f <scheduler+0x18f>
        p->turn = (p->turn+1)%(p->childCount+1) ; 
80103ebf:	8b be 80 00 00 00    	mov    0x80(%esi),%edi
80103ec5:	83 c0 01             	add    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){  
80103ec8:	81 c6 8c 00 00 00    	add    $0x8c,%esi
        p->turn = (p->turn+1)%(p->childCount+1) ; 
80103ece:	99                   	cltd   
80103ecf:	8d 4f 01             	lea    0x1(%edi),%ecx
80103ed2:	f7 f9                	idiv   %ecx
80103ed4:	89 56 f8             	mov    %edx,-0x8(%esi)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){  
80103ed7:	81 fe 54 50 11 80    	cmp    $0x80115054,%esi
80103edd:	0f 85 59 ff ff ff    	jne    80103e3c <scheduler+0xbc>
    release(&ptable.lock);
80103ee3:	83 ec 0c             	sub    $0xc,%esp
80103ee6:	68 20 2d 11 80       	push   $0x80112d20
80103eeb:	e8 90 0a 00 00       	call   80104980 <release>
    sti();
80103ef0:	83 c4 10             	add    $0x10,%esp
80103ef3:	e9 a0 fe ff ff       	jmp    80103d98 <scheduler+0x18>
80103ef8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103eff:	90                   	nop
          p->turn = 1 ;
80103f00:	c7 86 84 00 00 00 01 	movl   $0x1,0x84(%esi)
80103f07:	00 00 00 
        if ( p->turn != 0 )
80103f0a:	b8 01 00 00 00       	mov    $0x1,%eax
80103f0f:	ba 01 00 00 00       	mov    $0x1,%edx
80103f14:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103f19:	eb 13                	jmp    80103f2e <scheduler+0x1ae>
80103f1b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103f1f:	90                   	nop
          for(childProc = ptable.proc; childProc < &ptable.proc[NPROC]; childProc++)
80103f20:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
80103f26:	81 fb 54 50 11 80    	cmp    $0x80115054,%ebx
80103f2c:	74 32                	je     80103f60 <scheduler+0x1e0>
            if ( childProc->parent == p && childProc->IsThread==1 &&  childProc->state == RUNNABLE ) // && childProc->state == RUNNABLE
80103f2e:	39 73 18             	cmp    %esi,0x18(%ebx)
80103f31:	75 ed                	jne    80103f20 <scheduler+0x1a0>
80103f33:	83 bb 88 00 00 00 01 	cmpl   $0x1,0x88(%ebx)
80103f3a:	75 e4                	jne    80103f20 <scheduler+0x1a0>
80103f3c:	83 7b 10 03          	cmpl   $0x3,0x10(%ebx)
80103f40:	75 de                	jne    80103f20 <scheduler+0x1a0>
                if (count == p->turn)
80103f42:	39 d0                	cmp    %edx,%eax
80103f44:	74 25                	je     80103f6b <scheduler+0x1eb>
          for(childProc = ptable.proc; childProc < &ptable.proc[NPROC]; childProc++)
80103f46:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
                count++ ; 
80103f4c:	83 c2 01             	add    $0x1,%edx
          for(childProc = ptable.proc; childProc < &ptable.proc[NPROC]; childProc++)
80103f4f:	81 fb 54 50 11 80    	cmp    $0x80115054,%ebx
80103f55:	75 d7                	jne    80103f2e <scheduler+0x1ae>
80103f57:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103f5e:	66 90                	xchg   %ax,%ax
        p->turn = (p->turn+1)%(p->childCount+1) ; 
80103f60:	8b 86 84 00 00 00    	mov    0x84(%esi),%eax
80103f66:	e9 54 ff ff ff       	jmp    80103ebf <scheduler+0x13f>
                  struct cpu *c = mycpu();
80103f6b:	e8 90 f9 ff ff       	call   80103900 <mycpu>
                  switchuvm(childProc);
80103f70:	83 ec 0c             	sub    $0xc,%esp
                  c->proc=childProc;
80103f73:	89 98 ac 00 00 00    	mov    %ebx,0xac(%eax)
                  struct cpu *c = mycpu();
80103f79:	89 c7                	mov    %eax,%edi
                  switchuvm(childProc);
80103f7b:	53                   	push   %ebx
80103f7c:	e8 4f 2f 00 00       	call   80106ed0 <switchuvm>
                  childProc->state = RUNNING;
80103f81:	c7 43 10 04 00 00 00 	movl   $0x4,0x10(%ebx)
                  cprintf("process :%d \n" , childProc->pid ); 
80103f88:	59                   	pop    %ecx
80103f89:	58                   	pop    %eax
80103f8a:	ff 73 14             	push   0x14(%ebx)
80103f8d:	68 fb 7b 10 80       	push   $0x80107bfb
80103f92:	e8 09 c7 ff ff       	call   801006a0 <cprintf>
                  swtch(&(c->scheduler), childProc->context);
80103f97:	58                   	pop    %eax
80103f98:	8d 47 04             	lea    0x4(%edi),%eax
80103f9b:	5a                   	pop    %edx
80103f9c:	ff 73 20             	push   0x20(%ebx)
80103f9f:	50                   	push   %eax
80103fa0:	e8 16 0d 00 00       	call   80104cbb <swtch>
                  switchkvm();
80103fa5:	e8 16 2f 00 00       	call   80106ec0 <switchkvm>
                  break;  
80103faa:	83 c4 10             	add    $0x10,%esp
                  c->proc = 0;
80103fad:	c7 87 ac 00 00 00 00 	movl   $0x0,0xac(%edi)
80103fb4:	00 00 00 
        p->turn = (p->turn+1)%(p->childCount+1) ; 
80103fb7:	8b 86 84 00 00 00    	mov    0x84(%esi),%eax
                  break;  
80103fbd:	e9 fd fe ff ff       	jmp    80103ebf <scheduler+0x13f>
...
80104017:	75 41                	jne    8010405a <sched+0x8a>
  intena = mycpu()->intena;
80104019:	e8 e2 f8 ff ff       	call   80103900 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
8010401e:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
80104021:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80104027:	e8 d4 f8 ff ff       	call   80103900 <mycpu>
8010402c:	83 ec 08             	sub    $0x8,%esp
8010402f:	ff 70 04             	push   0x4(%eax)
80104032:	53                   	push   %ebx
80104033:	e8 83 0c 00 00       	call   80104cbb <swtch>
  mycpu()->intena = intena;
...
80104096:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80104099:	e8 e2 f8 ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
8010409e:	39 05 54 50 11 80    	cmp    %eax,0x80115054
801040a4:	0f 84 07 01 00 00    	je     801041b1 <exit+0x121>
801040aa:	89 c3                	mov    %eax,%ebx
801040ac:	8d 70 2c             	lea    0x2c(%eax),%esi
801040af:	8d 78 6c             	lea    0x6c(%eax),%edi
...
801040d5:	75 e1                	jne    801040b8 <exit+0x28>
  begin_op();
801040d7:	e8 84 ec ff ff       	call   80102d60 <begin_op>
  iput(curproc->cwd);
801040dc:	83 ec 0c             	sub    $0xc,%esp
801040df:	ff 73 6c             	push   0x6c(%ebx)
801040e2:	e8 c9 d7 ff ff       	call   801018b0 <iput>
  end_op();
801040e7:	e8 e4 ec ff ff       	call   80102dd0 <end_op>
  curproc->cwd = 0;
801040ec:	c7 43 6c 00 00 00 00 	movl   $0x0,0x6c(%ebx)
  acquire(&ptable.lock);
801040f3:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801040fa:	e8 e1 08 00 00       	call   801049e0 <acquire>
  wakeup1(curproc->parent);
801040ff:	8b 53 18             	mov    0x18(%ebx),%edx
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104105:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
8010410a:	eb 10                	jmp    8010411c <exit+0x8c>
8010410c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104110:	05 8c 00 00 00       	add    $0x8c,%eax
80104115:	3d 54 50 11 80       	cmp    $0x80115054,%eax
8010411a:	74 1e                	je     8010413a <exit+0xaa>
    if(p->state == SLEEPING && p->chan == chan)
8010411c:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80104120:	75 ee                	jne    80104110 <exit+0x80>
80104122:	3b 50 24             	cmp    0x24(%eax),%edx
80104125:	75 e9                	jne    80104110 <exit+0x80>
      p->state = RUNNABLE;
80104127:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010412e:	05 8c 00 00 00       	add    $0x8c,%eax
80104133:	3d 54 50 11 80       	cmp    $0x80115054,%eax
80104138:	75 e2                	jne    8010411c <exit+0x8c>
      p->parent = initproc;
8010413a:	8b 0d 54 50 11 80    	mov    0x80115054,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104140:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80104145:	eb 17                	jmp    8010415e <exit+0xce>
80104147:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010414e:	66 90                	xchg   %ax,%ax
80104150:	81 c2 8c 00 00 00    	add    $0x8c,%edx
80104156:	81 fa 54 50 11 80    	cmp    $0x80115054,%edx
8010415c:	74 3a                	je     80104198 <exit+0x108>
    if(p->parent == curproc){
8010415e:	39 5a 18             	cmp    %ebx,0x18(%edx)
80104161:	75 ed                	jne    80104150 <exit+0xc0>
      if(p->state == ZOMBIE)
80104163:	83 7a 10 05          	cmpl   $0x5,0x10(%edx)
      p->parent = initproc;
80104167:	89 4a 18             	mov    %ecx,0x18(%edx)
      if(p->state == ZOMBIE)
8010416a:	75 e4                	jne    80104150 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010416c:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104171:	eb 11                	jmp    80104184 <exit+0xf4>
80104173:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104177:	90                   	nop
80104178:	05 8c 00 00 00       	add    $0x8c,%eax
8010417d:	3d 54 50 11 80       	cmp    $0x80115054,%eax
80104182:	74 cc                	je     80104150 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
80104184:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80104188:	75 ee                	jne    80104178 <exit+0xe8>
8010418a:	3b 48 24             	cmp    0x24(%eax),%ecx
8010418d:	75 e9                	jne    80104178 <exit+0xe8>
      p->state = RUNNABLE;
8010418f:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
80104196:	eb e0                	jmp    80104178 <exit+0xe8>
  curproc->state = ZOMBIE;
80104198:	c7 43 10 05 00 00 00 	movl   $0x5,0x10(%ebx)
  sched();
8010419f:	e8 2c fe ff ff       	call   80103fd0 <sched>
  panic("zombie exit");
801041a4:	83 ec 0c             	sub    $0xc,%esp
801041a7:	68 56 7c 10 80       	push   $0x80107c56
801041ac:	e8 cf c1 ff ff       	call   80100380 <panic>
    panic("init exiting");
801041b1:	83 ec 0c             	sub    $0xc,%esp
801041b4:	68 49 7c 10 80       	push   $0x80107c49
801041b9:	e8 c2 c1 ff ff       	call   80100380 <panic>
...
801041c4:	53                   	push   %ebx
  pushcli();
801041c5:	e8 c6 06 00 00       	call   80104890 <pushcli>
  c = mycpu();
801041ca:	e8 31 f7 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801041cf:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801041d5:	e8 06 07 00 00       	call   801048e0 <popcli>
  acquire(&ptable.lock);
801041da:	83 ec 0c             	sub    $0xc,%esp
801041dd:	68 20 2d 11 80       	push   $0x80112d20
801041e2:	e8 f9 07 00 00       	call   801049e0 <acquire>
801041e7:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
801041ea:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801041ec:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
801041f1:	eb 13                	jmp    80104206 <join+0x46>
801041f3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801041f7:	90                   	nop
801041f8:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
801041fe:	81 fb 54 50 11 80    	cmp    $0x80115054,%ebx
80104204:	74 26                	je     8010422c <join+0x6c>
      if(p->parent != cp || p->pgdir != p->parent->pgdir)
80104206:	39 73 18             	cmp    %esi,0x18(%ebx)
80104209:	75 ed                	jne    801041f8 <join+0x38>
8010420b:	8b 56 04             	mov    0x4(%esi),%edx
8010420e:	39 53 04             	cmp    %edx,0x4(%ebx)
80104211:	75 e5                	jne    801041f8 <join+0x38>
      if(p->state == ZOMBIE){
80104213:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
80104217:	74 67                	je     80104280 <join+0xc0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104219:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
      havekids = 1;
8010421f:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104224:	81 fb 54 50 11 80    	cmp    $0x80115054,%ebx
8010422a:	75 da                	jne    80104206 <join+0x46>
    if(!havekids || cp->killed){
8010422c:	85 c0                	test   %eax,%eax
8010422e:	0f 84 a0 00 00 00    	je     801042d4 <join+0x114>
80104234:	8b 46 28             	mov    0x28(%esi),%eax
80104237:	85 c0                	test   %eax,%eax
80104239:	0f 85 95 00 00 00    	jne    801042d4 <join+0x114>
  pushcli();
8010423f:	e8 4c 06 00 00       	call   80104890 <pushcli>
  c = mycpu();
80104244:	e8 b7 f6 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104249:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010424f:	e8 8c 06 00 00       	call   801048e0 <popcli>
  if(p == 0)
80104254:	85 db                	test   %ebx,%ebx
80104256:	0f 84 8f 00 00 00    	je     801042eb <join+0x12b>
  p->chan = chan;
8010425c:	89 73 24             	mov    %esi,0x24(%ebx)
  p->state = SLEEPING;
8010425f:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
80104266:	e8 65 fd ff ff       	call   80103fd0 <sched>
  p->chan = 0;
8010426b:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
}
80104272:	e9 73 ff ff ff       	jmp    801041ea <join+0x2a>
80104277:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010427e:	66 90                	xchg   %ax,%ax
        kfree(p->kstack);
80104280:	83 ec 0c             	sub    $0xc,%esp
        pid = p->pid;
80104283:	8b 73 14             	mov    0x14(%ebx),%esi
        kfree(p->kstack);
...
80104295:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
8010429c:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
801042a3:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
801042a7:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
801042ae:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->threadstack = 0;
801042b5:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801042bc:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801042c3:	e8 b8 06 00 00       	call   80104980 <release>
        return pid;
801042c8:	83 c4 10             	add    $0x10,%esp
}
801042cb:	8d 65 f8             	lea    -0x8(%ebp),%esp
801042ce:	89 f0                	mov    %esi,%eax
801042d0:	5b                   	pop    %ebx
801042d1:	5e                   	pop    %esi
801042d2:	5d                   	pop    %ebp
801042d3:	c3                   	ret    
...
801042d4:	83 ec 0c             	sub    $0xc,%esp
      return -1;
801042d7:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801042dc:	68 20 2d 11 80       	push   $0x80112d20
801042e1:	e8 9a 06 00 00       	call   80104980 <release>
      return -1;
801042e6:	83 c4 10             	add    $0x10,%esp
801042e9:	eb e0                	jmp    801042cb <join+0x10b>
    panic("sleep");
801042eb:	83 ec 0c             	sub    $0xc,%esp
801042ee:	68 62 7c 10 80       	push   $0x80107c62
801042f3:	e8 88 c0 ff ff       	call   80100380 <panic>
...
80104304:	53                   	push   %ebx
  pushcli();
80104305:	e8 86 05 00 00       	call   80104890 <pushcli>
  c = mycpu();
8010430a:	e8 f1 f5 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010430f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104315:	e8 c6 05 00 00       	call   801048e0 <popcli>
  acquire(&ptable.lock);
8010431a:	83 ec 0c             	sub    $0xc,%esp
8010431d:	68 20 2d 11 80       	push   $0x80112d20
80104322:	e8 b9 06 00 00       	call   801049e0 <acquire>
80104327:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010432a:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010432c:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80104331:	eb 13                	jmp    80104346 <wait+0x46>
80104333:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104337:	90                   	nop
80104338:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
8010433e:	81 fb 54 50 11 80    	cmp    $0x80115054,%ebx
80104344:	74 1e                	je     80104364 <wait+0x64>
      if(p->parent != curproc)
80104346:	39 73 18             	cmp    %esi,0x18(%ebx)
80104349:	75 ed                	jne    80104338 <wait+0x38>
      if(p->state == ZOMBIE){
8010434b:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
8010434f:	74 5f                	je     801043b0 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104351:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
      havekids = 1;
80104357:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010435c:	81 fb 54 50 11 80    	cmp    $0x80115054,%ebx
80104362:	75 e2                	jne    80104346 <wait+0x46>
    if(!havekids || curproc->killed){
80104364:	85 c0                	test   %eax,%eax
80104366:	0f 84 9a 00 00 00    	je     80104406 <wait+0x106>
8010436c:	8b 46 28             	mov    0x28(%esi),%eax
8010436f:	85 c0                	test   %eax,%eax
80104371:	0f 85 8f 00 00 00    	jne    80104406 <wait+0x106>
  pushcli();
80104377:	e8 14 05 00 00       	call   80104890 <pushcli>
  c = mycpu();
8010437c:	e8 7f f5 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104381:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104387:	e8 54 05 00 00       	call   801048e0 <popcli>
  if(p == 0)
8010438c:	85 db                	test   %ebx,%ebx
8010438e:	0f 84 89 00 00 00    	je     8010441d <wait+0x11d>
  p->chan = chan;
80104394:	89 73 24             	mov    %esi,0x24(%ebx)
  p->state = SLEEPING;
80104397:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
8010439e:	e8 2d fc ff ff       	call   80103fd0 <sched>
  p->chan = 0;
801043a3:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
}
801043aa:	e9 7b ff ff ff       	jmp    8010432a <wait+0x2a>
801043af:	90                   	nop
        kfree(p->kstack);
801043b0:	83 ec 0c             	sub    $0xc,%esp
        pid = p->pid;
801043b3:	8b 73 14             	mov    0x14(%ebx),%esi
        kfree(p->kstack);
801043b6:	ff 73 08             	push   0x8(%ebx)
801043b9:	e8 02 e1 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
801043be:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801043c5:	5a                   	pop    %edx
801043c6:	ff 73 04             	push   0x4(%ebx)
801043c9:	e8 e2 2e 00 00       	call   801072b0 <freevm>
        p->pid = 0;
801043ce:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
801043d5:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
801043dc:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
801043e0:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
801043e7:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        release(&ptable.lock);
801043ee:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801043f5:	e8 86 05 00 00       	call   80104980 <release>
        return pid;
801043fa:	83 c4 10             	add    $0x10,%esp
}
801043fd:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104400:	89 f0                	mov    %esi,%eax
80104402:	5b                   	pop    %ebx
80104403:	5e                   	pop    %esi
80104404:	5d                   	pop    %ebp
80104405:	c3                   	ret    
...
80104406:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80104409:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
8010440e:	68 20 2d 11 80       	push   $0x80112d20
80104413:	e8 68 05 00 00       	call   80104980 <release>
      return -1;
80104418:	83 c4 10             	add    $0x10,%esp
8010441b:	eb e0                	jmp    801043fd <wait+0xfd>
    panic("sleep");
8010441d:	83 ec 0c             	sub    $0xc,%esp
80104420:	68 62 7c 10 80       	push   $0x80107c62
80104425:	e8 56 bf ff ff       	call   80100380 <panic>
...
80104437:	68 20 2d 11 80       	push   $0x80112d20
8010443c:	e8 9f 05 00 00       	call   801049e0 <acquire>
  pushcli();
80104441:	e8 4a 04 00 00       	call   80104890 <pushcli>
  c = mycpu();
80104446:	e8 b5 f4 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010444b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104451:	e8 8a 04 00 00       	call   801048e0 <popcli>
  myproc()->state = RUNNABLE;
80104456:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  sched();
8010445d:	e8 6e fb ff ff       	call   80103fd0 <sched>
  release(&ptable.lock);
80104462:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104469:	e8 12 05 00 00       	call   80104980 <release>
}
...
8010448c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010448f:	e8 fc 03 00 00       	call   80104890 <pushcli>
  c = mycpu();
80104494:	e8 67 f4 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104499:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010449f:	e8 3c 04 00 00       	call   801048e0 <popcli>
  if(p == 0)
...
801044b0:	81 fe 20 2d 11 80    	cmp    $0x80112d20,%esi
801044b6:	74 50                	je     80104508 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
801044b8:	83 ec 0c             	sub    $0xc,%esp
801044bb:	68 20 2d 11 80       	push   $0x80112d20
801044c0:	e8 1b 05 00 00       	call   801049e0 <acquire>
    release(lk);
801044c5:	89 34 24             	mov    %esi,(%esp)
801044c8:	e8 b3 04 00 00       	call   80104980 <release>
  p->chan = chan;
801044cd:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
801044d0:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
801044d7:	e8 f4 fa ff ff       	call   80103fd0 <sched>
  p->chan = 0;
801044dc:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
    release(&ptable.lock);
801044e3:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801044ea:	e8 91 04 00 00       	call   80104980 <release>
    acquire(lk);
...
801044fb:	5d                   	pop    %ebp
    acquire(lk);
801044fc:	e9 df 04 00 00       	jmp    801049e0 <acquire>
80104501:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  p->chan = chan;
80104508:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
8010450b:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
80104512:	e8 b9 fa ff ff       	call   80103fd0 <sched>
  p->chan = 0;
...
80104529:	68 68 7c 10 80       	push   $0x80107c68
8010452e:	e8 4d be ff ff       	call   80100380 <panic>
    panic("sleep");
80104533:	83 ec 0c             	sub    $0xc,%esp
80104536:	68 62 7c 10 80       	push   $0x80107c62
8010453b:	e8 40 be ff ff       	call   80100380 <panic>
...
80104560:	05 8c 00 00 00       	add    $0x8c,%eax
80104565:	3d 54 50 11 80       	cmp    $0x80115054,%eax
8010456a:	74 1e                	je     8010458a <wakeup+0x4a>
    if(p->state == SLEEPING && p->chan == chan)
8010456c:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80104570:	75 ee                	jne    80104560 <wakeup+0x20>
80104572:	3b 58 24             	cmp    0x24(%eax),%ebx
80104575:	75 e9                	jne    80104560 <wakeup+0x20>
      p->state = RUNNABLE;
80104577:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010457e:	05 8c 00 00 00       	add    $0x8c,%eax
80104583:	3d 54 50 11 80       	cmp    $0x80115054,%eax
80104588:	75 e2                	jne    8010456c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010458a:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
80104591:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104594:	c9                   	leave  
  release(&ptable.lock);
80104595:	e9 e6 03 00 00       	jmp    80104980 <release>
...
801045af:	e8 2c 04 00 00       	call   801049e0 <acquire>
...
801045c5:	3d 54 50 11 80       	cmp    $0x80115054,%eax
801045ca:	74 34                	je     80104600 <kill+0x60>
    if(p->pid == pid){
801045cc:	39 58 14             	cmp    %ebx,0x14(%eax)
801045cf:	75 ef                	jne    801045c0 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
801045d1:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
      p->killed = 1;
801045d5:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING)
801045dc:	75 07                	jne    801045e5 <kill+0x45>
        p->state = RUNNABLE;
801045de:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
      release(&ptable.lock);
801045e5:	83 ec 0c             	sub    $0xc,%esp
801045e8:	68 20 2d 11 80       	push   $0x80112d20
801045ed:	e8 8e 03 00 00       	call   80104980 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104603:	68 20 2d 11 80       	push   $0x80112d20
80104608:	e8 73 03 00 00       	call   80104980 <release>
}
...
80104625:	8d 75 e8             	lea    -0x18(%ebp),%esi
80104628:	53                   	push   %ebx
80104629:	bb c4 2d 11 80       	mov    $0x80112dc4,%ebx
...
8010463b:	68 07 7c 10 80       	push   $0x80107c07
80104640:	e8 5b c0 ff ff       	call   801006a0 <cprintf>
80104645:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104648:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
8010464e:	81 fb c4 50 11 80    	cmp    $0x801150c4,%ebx
80104654:	0f 84 7e 00 00 00    	je     801046d8 <procdump+0xb8>
    if(p->state == UNUSED)
8010465a:	8b 43 a0             	mov    -0x60(%ebx),%eax
8010465d:	85 c0                	test   %eax,%eax
8010465f:	74 e7                	je     80104648 <procdump+0x28>
      state = "???";
80104661:	ba 79 7c 10 80       	mov    $0x80107c79,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104666:	83 f8 05             	cmp    $0x5,%eax
80104669:	77 11                	ja     8010467c <procdump+0x5c>
8010466b:	8b 14 85 d8 7c 10 80 	mov    -0x7fef8328(,%eax,4),%edx
      state = "???";
80104672:	b8 79 7c 10 80       	mov    $0x80107c79,%eax
...
80104681:	68 7d 7c 10 80       	push   $0x80107c7d
80104686:	e8 15 c0 ff ff       	call   801006a0 <cprintf>
    if(p->state == SLEEPING){
...
8010469a:	8d 7d c0             	lea    -0x40(%ebp),%edi
8010469d:	50                   	push   %eax
8010469e:	8b 43 b0             	mov    -0x50(%ebx),%eax
801046a1:	8b 40 0c             	mov    0xc(%eax),%eax
801046a4:	83 c0 08             	add    $0x8,%eax
801046a7:	50                   	push   %eax
801046a8:	e8 83 01 00 00       	call   80104830 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801046b9:	83 c7 04             	add    $0x4,%edi
        cprintf(" %p", pc[i]);
801046bc:	52                   	push   %edx
801046bd:	68 c1 76 10 80       	push   $0x801076c1
801046c2:	e8 d9 bf ff ff       	call   801006a0 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
801046c7:	83 c4 10             	add    $0x10,%esp
801046ca:	39 fe                	cmp    %edi,%esi
801046cc:	75 e2                	jne    801046b0 <procdump+0x90>
801046ce:	e9 65 ff ff ff       	jmp    80104638 <procdump+0x18>
...
801046ea:	68 f0 7c 10 80       	push   $0x80107cf0
...
8010472f:	e8 ac 02 00 00       	call   801049e0 <acquire>
  while (lk->locked) {
...
80104745:	e8 36 fd ff ff       	call   80104480 <sleep>
  while (lk->locked) {
...
80104753:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104759:	e8 22 f2 ff ff       	call   80103980 <myproc>
...
8010476c:	5d                   	pop    %ebp
  release(&lk->lk);
8010476d:	e9 0e 02 00 00       	jmp    80104980 <release>
...
8010478f:	e8 4c 02 00 00       	call   801049e0 <acquire>
  lk->locked = 0;
...
801047a4:	e8 97 fd ff ff       	call   80104540 <wakeup>
  release(&lk->lk);
...
801047b4:	5d                   	pop    %ebp
  release(&lk->lk);
801047b5:	e9 c6 01 00 00       	jmp    80104980 <release>
...
801047d2:	e8 09 02 00 00       	call   801049e0 <acquire>
...
801047e4:	e8 97 01 00 00       	call   80104980 <release>
  return r;
}
...
801047fb:	e8 80 f1 ff ff       	call   80103980 <myproc>
...
80104899:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010489a:	e8 61 f0 ff ff       	call   80103900 <mycpu>
8010489f:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801048a5:	85 c0                	test   %eax,%eax
801048a7:	74 17                	je     801048c0 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
801048a9:	e8 52 f0 ff ff       	call   80103900 <mycpu>
801048ae:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
801048ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
801048c0:	e8 3b f0 ff ff       	call   80103900 <mycpu>
801048c5:	81 e3 00 02 00 00    	and    $0x200,%ebx
801048cb:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
801048d1:	eb d6                	jmp    801048a9 <pushcli+0x19>
...
801048eb:	75 35                	jne    80104922 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
801048ed:	e8 0e f0 ff ff       	call   80103900 <mycpu>
...
8010490c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104910:	e8 eb ef ff ff       	call   80103900 <mycpu>
...
80104925:	68 fb 7c 10 80       	push   $0x80107cfb
8010492a:	e8 51 ba ff ff       	call   80100380 <panic>
    panic("popcli");
8010492f:	83 ec 0c             	sub    $0xc,%esp
80104932:	68 12 7d 10 80       	push   $0x80107d12
...
80104953:	75 0b                	jne    80104960 <holding+0x20>
  popcli();
80104955:	e8 86 ff ff ff       	call   801048e0 <popcli>
}
...
8010495f:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
80104960:	8b 5e 08             	mov    0x8(%esi),%ebx
80104963:	e8 98 ef ff ff       	call   80103900 <mycpu>
80104968:	39 c3                	cmp    %eax,%ebx
8010496a:	0f 94 c3             	sete   %bl
  popcli();
8010496d:	e8 6e ff ff ff       	call   801048e0 <popcli>
  r = lock->locked && lock->cpu == mycpu();
80104972:	0f b6 db             	movzbl %bl,%ebx
}
80104975:	89 d8                	mov    %ebx,%eax
80104977:	5b                   	pop    %ebx
80104978:	5e                   	pop    %esi
80104979:	5d                   	pop    %ebp
8010497a:	c3                   	ret    
...
80104985:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80104988:	e8 03 ff ff ff       	call   80104890 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
8010498d:	8b 03                	mov    (%ebx),%eax
8010498f:	85 c0                	test   %eax,%eax
80104991:	75 15                	jne    801049a8 <release+0x28>
  popcli();
80104993:	e8 48 ff ff ff       	call   801048e0 <popcli>
    panic("release");
80104998:	83 ec 0c             	sub    $0xc,%esp
8010499b:	68 19 7d 10 80       	push   $0x80107d19
801049a0:	e8 db b9 ff ff       	call   80100380 <panic>
801049a5:	8d 76 00             	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
801049a8:	8b 73 08             	mov    0x8(%ebx),%esi
801049ab:	e8 50 ef ff ff       	call   80103900 <mycpu>
801049b0:	39 c6                	cmp    %eax,%esi
801049b2:	75 df                	jne    80104993 <release+0x13>
  popcli();
801049b4:	e8 27 ff ff ff       	call   801048e0 <popcli>
  lk->pcs[0] = 0;
...
801049d7:	5d                   	pop    %ebp
  popcli();
801049d8:	e9 03 ff ff ff       	jmp    801048e0 <popcli>
...
801049e7:	e8 a4 fe ff ff       	call   80104890 <pushcli>
  if(holding(lk))
801049ec:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
801049ef:	e8 9c fe ff ff       	call   80104890 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801049f4:	8b 03                	mov    (%ebx),%eax
801049f6:	85 c0                	test   %eax,%eax
801049f8:	75 7e                	jne    80104a78 <acquire+0x98>
  popcli();
801049fa:	e8 e1 fe ff ff       	call   801048e0 <popcli>
  asm volatile("lock; xchgl %0, %1" :
801049ff:	b9 01 00 00 00       	mov    $0x1,%ecx
80104a04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  while(xchg(&lk->locked, 1) != 0)
80104a08:	8b 55 08             	mov    0x8(%ebp),%edx
80104a0b:	89 c8                	mov    %ecx,%eax
80104a0d:	f0 87 02             	lock xchg %eax,(%edx)
80104a10:	85 c0                	test   %eax,%eax
80104a12:	75 f4                	jne    80104a08 <acquire+0x28>
  __sync_synchronize();
80104a14:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80104a19:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104a1c:	e8 df ee ff ff       	call   80103900 <mycpu>
  getcallerpcs(&lk, lk->pcs);
80104a21:	8b 4d 08             	mov    0x8(%ebp),%ecx
  ebp = (uint*)v - 2;
80104a24:	89 ea                	mov    %ebp,%edx
  lk->cpu = mycpu();
80104a26:	89 43 08             	mov    %eax,0x8(%ebx)
  for(i = 0; i < 10; i++){
80104a29:	31 c0                	xor    %eax,%eax
80104a2b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104a2f:	90                   	nop
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104a30:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
80104a36:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80104a3c:	77 1a                	ja     80104a58 <acquire+0x78>
    pcs[i] = ebp[1];     // saved %eip
80104a3e:	8b 5a 04             	mov    0x4(%edx),%ebx
80104a41:	89 5c 81 0c          	mov    %ebx,0xc(%ecx,%eax,4)
  for(i = 0; i < 10; i++){
80104a45:	83 c0 01             	add    $0x1,%eax
    ebp = (uint*)ebp[0]; // saved %ebp
80104a48:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
...
80104a54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(; i < 10; i++)
80104a58:	8d 44 81 0c          	lea    0xc(%ecx,%eax,4),%eax
80104a5c:	8d 51 34             	lea    0x34(%ecx),%edx
80104a5f:	90                   	nop
    pcs[i] = 0;
...
80104a6b:	75 f3                	jne    80104a60 <acquire+0x80>
}
...
80104a72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
80104a78:	8b 5b 08             	mov    0x8(%ebx),%ebx
80104a7b:	e8 80 ee ff ff       	call   80103900 <mycpu>
80104a80:	39 c3                	cmp    %eax,%ebx
80104a82:	0f 85 72 ff ff ff    	jne    801049fa <acquire+0x1a>
  popcli();
80104a88:	e8 53 fe ff ff       	call   801048e0 <popcli>
    panic("acquire");
80104a8d:	83 ec 0c             	sub    $0xc,%esp
80104a90:	68 21 7d 10 80       	push   $0x80107d21
...
80104aae:	89 d7                	mov    %edx,%edi
80104ab0:	09 cf                	or     %ecx,%edi
80104ab2:	83 e7 03             	and    $0x3,%edi
80104ab5:	75 29                	jne    80104ae0 <memset+0x40>
    c &= 0xFF;
80104ab7:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80104aba:	c1 e0 18             	shl    $0x18,%eax
80104abd:	89 fb                	mov    %edi,%ebx
80104abf:	c1 e9 02             	shr    $0x2,%ecx
80104ac2:	c1 e3 10             	shl    $0x10,%ebx
80104ac5:	09 d8                	or     %ebx,%eax
80104ac7:	09 f8                	or     %edi,%eax
80104ac9:	c1 e7 08             	shl    $0x8,%edi
80104acc:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
80104ace:	89 d7                	mov    %edx,%edi
80104ad0:	fc                   	cld    
...
80104ad3:	5b                   	pop    %ebx
80104ad4:	89 d0                	mov    %edx,%eax
80104ad6:	5f                   	pop    %edi
80104ad7:	5d                   	pop    %ebp
80104ad8:	c3                   	ret    
80104ad9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  asm volatile("cld; rep stosb" :
80104ae0:	89 d7                	mov    %edx,%edi
80104ae2:	fc                   	cld    
80104ae3:	f3 aa                	rep stos %al,%es:(%edi)
80104ae5:	5b                   	pop    %ebx
80104ae6:	89 d0                	mov    %edx,%eax
80104ae8:	5f                   	pop    %edi
80104ae9:	5d                   	pop    %ebp
80104aea:	c3                   	ret    
...
80104b00:	74 2e                	je     80104b30 <memcmp+0x40>
80104b02:	01 c6                	add    %eax,%esi
80104b04:	eb 14                	jmp    80104b1a <memcmp+0x2a>
...
80104b13:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80104b16:	39 f0                	cmp    %esi,%eax
80104b18:	74 16                	je     80104b30 <memcmp+0x40>
    if(*s1 != *s2)
80104b1a:	0f b6 0a             	movzbl (%edx),%ecx
80104b1d:	0f b6 18             	movzbl (%eax),%ebx
80104b20:	38 d9                	cmp    %bl,%cl
80104b22:	74 ec                	je     80104b10 <memcmp+0x20>
      return *s1 - *s2;
80104b24:	0f b6 c1             	movzbl %cl,%eax
80104b27:	29 d8                	sub    %ebx,%eax
  }
...
80104b4b:	8b 75 0c             	mov    0xc(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80104b4e:	39 d6                	cmp    %edx,%esi
80104b50:	73 26                	jae    80104b78 <memmove+0x38>
80104b52:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
80104b55:	39 fa                	cmp    %edi,%edx
80104b57:	73 1f                	jae    80104b78 <memmove+0x38>
80104b59:	8d 41 ff             	lea    -0x1(%ecx),%eax
    s += n;
    d += n;
    while(n-- > 0)
80104b5c:	85 c9                	test   %ecx,%ecx
80104b5e:	74 0c                	je     80104b6c <memmove+0x2c>
      *--d = *--s;
80104b60:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
80104b64:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
80104b67:	83 e8 01             	sub    $0x1,%eax
80104b6a:	73 f4                	jae    80104b60 <memmove+0x20>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
80104b6c:	5e                   	pop    %esi
80104b6d:	89 d0                	mov    %edx,%eax
80104b6f:	5f                   	pop    %edi
80104b70:	5d                   	pop    %ebp
80104b71:	c3                   	ret    
80104b72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(n-- > 0)
80104b78:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
80104b7b:	89 d7                	mov    %edx,%edi
80104b7d:	85 c9                	test   %ecx,%ecx
80104b7f:	74 eb                	je     80104b6c <memmove+0x2c>
80104b81:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      *d++ = *s++;
80104b88:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
80104b89:	39 c6                	cmp    %eax,%esi
80104b8b:	75 fb                	jne    80104b88 <memmove+0x48>
}
80104b8d:	5e                   	pop    %esi
...
80104ba0:	eb 9e                	jmp    80104b40 <memmove>
...
80104bb7:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104bba:	53                   	push   %ebx
80104bbb:	8b 55 0c             	mov    0xc(%ebp),%edx
  while(n > 0 && *p && *p == *q)
80104bbe:	85 f6                	test   %esi,%esi
80104bc0:	74 2e                	je     80104bf0 <strncmp+0x40>
80104bc2:	01 d6                	add    %edx,%esi
80104bc4:	eb 18                	jmp    80104bde <strncmp+0x2e>
80104bc6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104bcd:	8d 76 00             	lea    0x0(%esi),%esi
80104bd0:	38 d8                	cmp    %bl,%al
80104bd2:	75 14                	jne    80104be8 <strncmp+0x38>
    n--, p++, q++;
80104bd4:	83 c2 01             	add    $0x1,%edx
80104bd7:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80104bda:	39 f2                	cmp    %esi,%edx
80104bdc:	74 12                	je     80104bf0 <strncmp+0x40>
80104bde:	0f b6 01             	movzbl (%ecx),%eax
80104be1:	0f b6 1a             	movzbl (%edx),%ebx
80104be4:	84 c0                	test   %al,%al
80104be6:	75 e8                	jne    80104bd0 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104be8:	29 d8                	sub    %ebx,%eax
}
80104bea:	5b                   	pop    %ebx
80104beb:	5e                   	pop    %esi
80104bec:	5d                   	pop    %ebp
...
80104c09:	8b 4d 10             	mov    0x10(%ebp),%ecx
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80104c0c:	89 f0                	mov    %esi,%eax
80104c0e:	eb 15                	jmp    80104c25 <strncpy+0x25>
80104c10:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80104c14:	8b 7d 0c             	mov    0xc(%ebp),%edi
80104c17:	83 c0 01             	add    $0x1,%eax
80104c1a:	0f b6 57 ff          	movzbl -0x1(%edi),%edx
80104c1e:	88 50 ff             	mov    %dl,-0x1(%eax)
80104c21:	84 d2                	test   %dl,%dl
80104c23:	74 09                	je     80104c2e <strncpy+0x2e>
80104c25:	89 cb                	mov    %ecx,%ebx
80104c27:	83 e9 01             	sub    $0x1,%ecx
80104c2a:	85 db                	test   %ebx,%ebx
80104c2c:	7f e2                	jg     80104c10 <strncpy+0x10>
    ;
  while(n-- > 0)
80104c2e:	89 c2                	mov    %eax,%edx
80104c30:	85 c9                	test   %ecx,%ecx
80104c32:	7e 17                	jle    80104c4b <strncpy+0x4b>
80104c34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    *s++ = 0;
80104c38:	83 c2 01             	add    $0x1,%edx
80104c3b:	89 c1                	mov    %eax,%ecx
80104c3d:	c6 42 ff 00          	movb   $0x0,-0x1(%edx)
  while(n-- > 0)
80104c41:	29 d1                	sub    %edx,%ecx
80104c43:	8d 4c 0b ff          	lea    -0x1(%ebx,%ecx,1),%ecx
80104c47:	85 c9                	test   %ecx,%ecx
80104c49:	7f ed                	jg     80104c38 <strncpy+0x38>
  return os;
}
80104c4b:	5b                   	pop    %ebx
80104c4c:	89 f0                	mov    %esi,%eax
80104c4e:	5e                   	pop    %esi
80104c4f:	5f                   	pop    %edi
80104c50:	5d                   	pop    %ebp
80104c51:	c3                   	ret    
...
80104c67:	8b 75 08             	mov    0x8(%ebp),%esi
...
80104c6b:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  os = s;
  if(n <= 0)
80104c6e:	85 d2                	test   %edx,%edx
80104c70:	7e 25                	jle    80104c97 <safestrcpy+0x37>
80104c72:	8d 5c 10 ff          	lea    -0x1(%eax,%edx,1),%ebx
80104c76:	89 f2                	mov    %esi,%edx
80104c78:	eb 16                	jmp    80104c90 <safestrcpy+0x30>
80104c7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
80104c80:	0f b6 08             	movzbl (%eax),%ecx
80104c83:	83 c0 01             	add    $0x1,%eax
80104c86:	83 c2 01             	add    $0x1,%edx
80104c89:	88 4a ff             	mov    %cl,-0x1(%edx)
80104c8c:	84 c9                	test   %cl,%cl
80104c8e:	74 04                	je     80104c94 <safestrcpy+0x34>
80104c90:	39 d8                	cmp    %ebx,%eax
80104c92:	75 ec                	jne    80104c80 <safestrcpy+0x20>
    ;
  *s = 0;
80104c94:	c6 02 00             	movb   $0x0,(%edx)
  return os;
}
80104c97:	89 f0                	mov    %esi,%eax
80104c99:	5b                   	pop    %ebx
80104c9a:	5e                   	pop    %esi
80104c9b:	5d                   	pop    %ebp
80104c9c:	c3                   	ret    
...
80104ca5:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
80104ca8:	80 3a 00             	cmpb   $0x0,(%edx)
80104cab:	74 0c                	je     80104cb9 <strlen+0x19>
80104cad:	8d 76 00             	lea    0x0(%esi),%esi
80104cb0:	83 c0 01             	add    $0x1,%eax
80104cb3:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80104cb7:	75 f7                	jne    80104cb0 <strlen+0x10>
    ;
  return n;
}
80104cb9:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80104cbb:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80104cbf:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80104cc6:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80104cc7:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80104cc9:	89 d4                	mov    %edx,%esp
...
80104ce1:	39 d8                	cmp    %ebx,%eax
80104ce3:	76 1b                	jbe    80104d00 <fetchint+0x30>
80104ce5:	8d 53 04             	lea    0x4(%ebx),%edx
80104ce8:	39 d0                	cmp    %edx,%eax
80104cea:	72 14                	jb     80104d00 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
80104cec:	8b 45 0c             	mov    0xc(%ebp),%eax
80104cef:	8b 13                	mov    (%ebx),%edx
...
80104d05:	eb ee                	jmp    80104cf5 <fetchint+0x25>
...
80104d17:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104d1a:	e8 61 ec ff ff       	call   80103980 <myproc>

  if(addr >= curproc->sz)
80104d1f:	39 18                	cmp    %ebx,(%eax)
80104d21:	76 2d                	jbe    80104d50 <fetchstr+0x40>
    return -1;
  *pp = (char*)addr;
80104d23:	8b 55 0c             	mov    0xc(%ebp),%edx
80104d26:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
80104d28:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
80104d2a:	39 d3                	cmp    %edx,%ebx
80104d2c:	73 22                	jae    80104d50 <fetchstr+0x40>
80104d2e:	89 d8                	mov    %ebx,%eax
80104d30:	eb 0d                	jmp    80104d3f <fetchstr+0x2f>
80104d32:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104d38:	83 c0 01             	add    $0x1,%eax
80104d3b:	39 c2                	cmp    %eax,%edx
80104d3d:	76 11                	jbe    80104d50 <fetchstr+0x40>
    if(*s == 0)
80104d3f:	80 38 00             	cmpb   $0x0,(%eax)
80104d42:	75 f4                	jne    80104d38 <fetchstr+0x28>
      return s - *pp;
...
80104db6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104db9:	e8 c2 eb ff ff       	call   80103980 <myproc>
80104dbe:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104dc0:	e8 bb eb ff ff       	call   80103980 <myproc>
80104dc5:	8b 55 08             	mov    0x8(%ebp),%edx
80104dc8:	8b 40 1c             	mov    0x1c(%eax),%eax
80104dcb:	8b 40 44             	mov    0x44(%eax),%eax
80104dce:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104dd1:	e8 aa eb ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104dd6:	8d 7b 04             	lea    0x4(%ebx),%edi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104dd9:	8b 00                	mov    (%eax),%eax
80104ddb:	39 c7                	cmp    %eax,%edi
80104ddd:	73 31                	jae    80104e10 <argptr+0x60>
80104ddf:	8d 4b 08             	lea    0x8(%ebx),%ecx
80104de2:	39 c8                	cmp    %ecx,%eax
80104de4:	72 2a                	jb     80104e10 <argptr+0x60>
 
  if(argint(n, &i) < 0)
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104de6:	8b 55 10             	mov    0x10(%ebp),%edx
  *ip = *(int*)(addr);
80104de9:	8b 43 04             	mov    0x4(%ebx),%eax
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104dec:	85 d2                	test   %edx,%edx
80104dee:	78 20                	js     80104e10 <argptr+0x60>
80104df0:	8b 16                	mov    (%esi),%edx
80104df2:	39 c2                	cmp    %eax,%edx
80104df4:	76 1a                	jbe    80104e10 <argptr+0x60>
80104df6:	8b 5d 10             	mov    0x10(%ebp),%ebx
80104df9:	01 c3                	add    %eax,%ebx
80104dfb:	39 da                	cmp    %ebx,%edx
80104dfd:	72 11                	jb     80104e10 <argptr+0x60>
    return -1;
  *pp = (char*)i;
80104dff:	8b 55 0c             	mov    0xc(%ebp),%edx
80104e02:	89 02                	mov    %eax,(%edx)
  return 0;
...
80104e15:	eb ef                	jmp    80104e06 <argptr+0x56>
...
80104e42:	73 44                	jae    80104e88 <argstr+0x68>
80104e44:	8d 53 08             	lea    0x8(%ebx),%edx
80104e47:	39 d0                	cmp    %edx,%eax
80104e49:	72 3d                	jb     80104e88 <argstr+0x68>
  *ip = *(int*)(addr);
80104e4b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104e4e:	e8 2d eb ff ff       	call   80103980 <myproc>
  if(addr >= curproc->sz)
80104e53:	3b 18                	cmp    (%eax),%ebx
80104e55:	73 31                	jae    80104e88 <argstr+0x68>
  *pp = (char*)addr;
...
80104e60:	73 26                	jae    80104e88 <argstr+0x68>
80104e62:	89 d8                	mov    %ebx,%eax
80104e64:	eb 11                	jmp    80104e77 <argstr+0x57>
...
80104e75:	76 11                	jbe    80104e88 <argstr+0x68>
    if(*s == 0)
80104e77:	80 38 00             	cmpb   $0x0,(%eax)
80104e7a:	75 f4                	jne    80104e70 <argstr+0x50>
      return s - *pp;
80104e7c:	29 d8                	sub    %ebx,%eax
  int addr;
  if(argint(n, &addr) < 0)
    return -1;
...
80104ea4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104ea7:	e8 d4 ea ff ff       	call   80103980 <myproc>
80104eac:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104eae:	8b 40 1c             	mov    0x1c(%eax),%eax
80104eb1:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104eb4:	8d 50 ff             	lea    -0x1(%eax),%edx
80104eb7:	83 fa 16             	cmp    $0x16,%edx
80104eba:	77 24                	ja     80104ee0 <syscall+0x40>
80104ebc:	8b 14 85 60 7d 10 80 	mov    -0x7fef82a0(,%eax,4),%edx
80104ec3:	85 d2                	test   %edx,%edx
80104ec5:	74 19                	je     80104ee0 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
80104ec7:	ff d2                	call   *%edx
80104ec9:	89 c2                	mov    %eax,%edx
80104ecb:	8b 43 1c             	mov    0x1c(%ebx),%eax
80104ece:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104ed1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104ed4:	c9                   	leave  
80104ed5:	c3                   	ret    
...
80104ee0:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104ee1:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104ee4:	50                   	push   %eax
80104ee5:	ff 73 14             	push   0x14(%ebx)
80104ee8:	68 29 7d 10 80       	push   $0x80107d29
80104eed:	e8 ae b7 ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
80104ef2:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104f02:	c9                   	leave  
80104f03:	c3                   	ret    
80104f04:	66 90                	xchg   %ax,%ax
80104f06:	66 90                	xchg   %ax,%ax
...
80104f15:	8d 7d da             	lea    -0x26(%ebp),%edi
{
80104f18:	53                   	push   %ebx
80104f19:	83 ec 34             	sub    $0x34,%esp
80104f1c:	89 4d d0             	mov    %ecx,-0x30(%ebp)
80104f1f:	8b 4d 08             	mov    0x8(%ebp),%ecx
  if((dp = nameiparent(path, name)) == 0)
80104f22:	57                   	push   %edi
80104f23:	50                   	push   %eax
{
80104f24:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104f27:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104f2a:	e8 91 d1 ff ff       	call   801020c0 <nameiparent>
80104f2f:	83 c4 10             	add    $0x10,%esp
80104f32:	85 c0                	test   %eax,%eax
80104f34:	0f 84 46 01 00 00    	je     80105080 <create+0x170>
    return 0;
  ilock(dp);
80104f3a:	83 ec 0c             	sub    $0xc,%esp
80104f3d:	89 c3                	mov    %eax,%ebx
80104f3f:	50                   	push   %eax
80104f40:	e8 3b c8 ff ff       	call   80101780 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80104f45:	83 c4 0c             	add    $0xc,%esp
80104f48:	6a 00                	push   $0x0
80104f4a:	57                   	push   %edi
80104f4b:	53                   	push   %ebx
80104f4c:	e8 8f cd ff ff       	call   80101ce0 <dirlookup>
80104f51:	83 c4 10             	add    $0x10,%esp
80104f54:	89 c6                	mov    %eax,%esi
80104f56:	85 c0                	test   %eax,%eax
80104f58:	74 56                	je     80104fb0 <create+0xa0>
    iunlockput(dp);
80104f5a:	83 ec 0c             	sub    $0xc,%esp
80104f5d:	53                   	push   %ebx
80104f5e:	e8 ad ca ff ff       	call   80101a10 <iunlockput>
    ilock(ip);
80104f63:	89 34 24             	mov    %esi,(%esp)
80104f66:	e8 15 c8 ff ff       	call   80101780 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104f6b:	83 c4 10             	add    $0x10,%esp
80104f6e:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104f73:	75 1b                	jne    80104f90 <create+0x80>
80104f75:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
80104f7a:	75 14                	jne    80104f90 <create+0x80>
...
80104f93:	56                   	push   %esi
    return 0;
80104f94:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104f96:	e8 75 ca ff ff       	call   80101a10 <iunlockput>
    return 0;
80104f9b:	83 c4 10             	add    $0x10,%esp
}
80104f9e:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104fa1:	89 f0                	mov    %esi,%eax
80104fa3:	5b                   	pop    %ebx
80104fa4:	5e                   	pop    %esi
80104fa5:	5f                   	pop    %edi
80104fa6:	5d                   	pop    %ebp
...
80104fb0:	0f bf 45 d4          	movswl -0x2c(%ebp),%eax
80104fb4:	83 ec 08             	sub    $0x8,%esp
80104fb7:	50                   	push   %eax
80104fb8:	ff 33                	push   (%ebx)
80104fba:	e8 51 c6 ff ff       	call   80101610 <ialloc>
80104fbf:	83 c4 10             	add    $0x10,%esp
80104fc2:	89 c6                	mov    %eax,%esi
80104fc4:	85 c0                	test   %eax,%eax
80104fc6:	0f 84 cd 00 00 00    	je     80105099 <create+0x189>
  ilock(ip);
80104fcc:	83 ec 0c             	sub    $0xc,%esp
80104fcf:	50                   	push   %eax
80104fd0:	e8 ab c7 ff ff       	call   80101780 <ilock>
  ip->major = major;
80104fd5:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
80104fd9:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
80104fdd:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
80104fe1:	66 89 46 54          	mov    %ax,0x54(%esi)
  ip->nlink = 1;
80104fe5:	b8 01 00 00 00       	mov    $0x1,%eax
80104fea:	66 89 46 56          	mov    %ax,0x56(%esi)
  iupdate(ip);
80104fee:	89 34 24             	mov    %esi,(%esp)
80104ff1:	e8 da c6 ff ff       	call   801016d0 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80104ff6:	83 c4 10             	add    $0x10,%esp
80104ff9:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80104ffe:	74 30                	je     80105030 <create+0x120>
  if(dirlink(dp, name, ip->inum) < 0)
80105000:	83 ec 04             	sub    $0x4,%esp
80105003:	ff 76 04             	push   0x4(%esi)
80105006:	57                   	push   %edi
80105007:	53                   	push   %ebx
80105008:	e8 d3 cf ff ff       	call   80101fe0 <dirlink>
8010500d:	83 c4 10             	add    $0x10,%esp
80105010:	85 c0                	test   %eax,%eax
80105012:	78 78                	js     8010508c <create+0x17c>
  iunlockput(dp);
80105014:	83 ec 0c             	sub    $0xc,%esp
80105017:	53                   	push   %ebx
80105018:	e8 f3 c9 ff ff       	call   80101a10 <iunlockput>
  return ip;
8010501d:	83 c4 10             	add    $0x10,%esp
}
80105020:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105023:	89 f0                	mov    %esi,%eax
80105025:	5b                   	pop    %ebx
80105026:	5e                   	pop    %esi
80105027:	5f                   	pop    %edi
80105028:	5d                   	pop    %ebp
...
80105039:	e8 92 c6 ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010503e:	83 c4 0c             	add    $0xc,%esp
80105041:	ff 76 04             	push   0x4(%esi)
80105044:	68 dc 7d 10 80       	push   $0x80107ddc
80105049:	56                   	push   %esi
8010504a:	e8 91 cf ff ff       	call   80101fe0 <dirlink>
8010504f:	83 c4 10             	add    $0x10,%esp
80105052:	85 c0                	test   %eax,%eax
80105054:	78 18                	js     8010506e <create+0x15e>
80105056:	83 ec 04             	sub    $0x4,%esp
80105059:	ff 73 04             	push   0x4(%ebx)
8010505c:	68 db 7d 10 80       	push   $0x80107ddb
80105061:	56                   	push   %esi
80105062:	e8 79 cf ff ff       	call   80101fe0 <dirlink>
80105067:	83 c4 10             	add    $0x10,%esp
8010506a:	85 c0                	test   %eax,%eax
8010506c:	79 92                	jns    80105000 <create+0xf0>
      panic("create dots");
8010506e:	83 ec 0c             	sub    $0xc,%esp
80105071:	68 cf 7d 10 80       	push   $0x80107dcf
80105076:	e8 05 b3 ff ff       	call   80100380 <panic>
8010507b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010507f:	90                   	nop
}
80105080:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80105083:	31 f6                	xor    %esi,%esi
}
80105085:	5b                   	pop    %ebx
80105086:	89 f0                	mov    %esi,%eax
80105088:	5e                   	pop    %esi
80105089:	5f                   	pop    %edi
8010508a:	5d                   	pop    %ebp
8010508b:	c3                   	ret    
...
8010508f:	68 de 7d 10 80       	push   $0x80107dde
80105094:	e8 e7 b2 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80105099:	83 ec 0c             	sub    $0xc,%esp
8010509c:	68 c0 7d 10 80       	push   $0x80107dc0
801050a1:	e8 da b2 ff ff       	call   80100380 <panic>
...
801050be:	e8 9d fc ff ff       	call   80104d60 <argint>
801050c3:	83 c4 10             	add    $0x10,%esp
801050c6:	85 c0                	test   %eax,%eax
801050c8:	78 36                	js     80105100 <sys_dup+0x50>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
801050ca:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
801050ce:	77 30                	ja     80105100 <sys_dup+0x50>
...
80105110:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105113:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
80105117:	56                   	push   %esi
80105118:	e8 83 bd ff ff       	call   80100ea0 <filedup>
  return fd;
...
801051ad:	eb ed                	jmp    8010519c <sys_read+0x6c>
801051af:	90                   	nop
...
8010522d:	eb ed                	jmp    8010521c <sys_write+0x6c>
8010522f:	90                   	nop
...
8010523e:	e8 1d fb ff ff       	call   80104d60 <argint>
80105243:	83 c4 10             	add    $0x10,%esp
80105246:	85 c0                	test   %eax,%eax
80105248:	78 3e                	js     80105288 <sys_close+0x58>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
8010524a:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
8010524e:	77 38                	ja     80105288 <sys_close+0x58>
80105250:	e8 2b e7 ff ff       	call   80103980 <myproc>
80105255:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105258:	8d 5a 08             	lea    0x8(%edx),%ebx
8010525b:	8b 74 98 0c          	mov    0xc(%eax,%ebx,4),%esi
8010525f:	85 f6                	test   %esi,%esi
80105261:	74 25                	je     80105288 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80105263:	e8 18 e7 ff ff       	call   80103980 <myproc>
  fileclose(f);
80105268:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
8010526b:	c7 44 98 0c 00 00 00 	movl   $0x0,0xc(%eax,%ebx,4)
80105272:	00 
  fileclose(f);
...
8010527e:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105281:	5b                   	pop    %ebx
80105282:	5e                   	pop    %esi
80105283:	5d                   	pop    %ebp
80105284:	c3                   	ret    
...
8010528d:	eb ef                	jmp    8010527e <sys_close+0x4e>
8010528f:	90                   	nop
...
801052f5:	eb ec                	jmp    801052e3 <sys_fstat+0x53>
...
80105305:	8d 45 d4             	lea    -0x2c(%ebp),%eax
{
...
8010530f:	e8 0c fb ff ff       	call   80104e20 <argstr>
...
80105322:	8d 45 d0             	lea    -0x30(%ebp),%eax
80105325:	50                   	push   %eax
80105326:	6a 01                	push   $0x1
80105328:	e8 f3 fa ff ff       	call   80104e20 <argstr>
8010532d:	83 c4 10             	add    $0x10,%esp
80105330:	85 c0                	test   %eax,%eax
80105332:	0f 88 e2 00 00 00    	js     8010541a <sys_link+0x11a>
  begin_op();
80105338:	e8 23 da ff ff       	call   80102d60 <begin_op>
  if((ip = namei(old)) == 0){
8010533d:	83 ec 0c             	sub    $0xc,%esp
80105340:	ff 75 d4             	push   -0x2c(%ebp)
80105343:	e8 58 cd ff ff       	call   801020a0 <namei>
80105348:	83 c4 10             	add    $0x10,%esp
8010534b:	89 c3                	mov    %eax,%ebx
8010534d:	85 c0                	test   %eax,%eax
8010534f:	0f 84 e4 00 00 00    	je     80105439 <sys_link+0x139>
  ilock(ip);
80105355:	83 ec 0c             	sub    $0xc,%esp
80105358:	50                   	push   %eax
80105359:	e8 22 c4 ff ff       	call   80101780 <ilock>
  if(ip->type == T_DIR){
8010535e:	83 c4 10             	add    $0x10,%esp
80105361:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105366:	0f 84 b5 00 00 00    	je     80105421 <sys_link+0x121>
  iupdate(ip);
8010536c:	83 ec 0c             	sub    $0xc,%esp
  ip->nlink++;
8010536f:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80105374:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
80105377:	53                   	push   %ebx
80105378:	e8 53 c3 ff ff       	call   801016d0 <iupdate>
  iunlock(ip);
8010537d:	89 1c 24             	mov    %ebx,(%esp)
80105380:	e8 db c4 ff ff       	call   80101860 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105385:	58                   	pop    %eax
80105386:	5a                   	pop    %edx
80105387:	57                   	push   %edi
80105388:	ff 75 d0             	push   -0x30(%ebp)
8010538b:	e8 30 cd ff ff       	call   801020c0 <nameiparent>
80105390:	83 c4 10             	add    $0x10,%esp
80105393:	89 c6                	mov    %eax,%esi
...
801053ae:	ff 73 04             	push   0x4(%ebx)
801053b1:	57                   	push   %edi
801053b2:	56                   	push   %esi
801053b3:	e8 28 cc ff ff       	call   80101fe0 <dirlink>
...
801053cb:	e8 e0 c4 ff ff       	call   801018b0 <iput>
  end_op();
...
801053ec:	e8 1f c6 ff ff       	call   80101a10 <iunlockput>
    goto bad;
...
80105405:	e8 c6 c2 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
8010540a:	89 1c 24             	mov    %ebx,(%esp)
8010540d:	e8 fe c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105412:	e8 b9 d9 ff ff       	call   80102dd0 <end_op>
  return -1;
80105417:	83 c4 10             	add    $0x10,%esp
8010541a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010541f:	eb b9                	jmp    801053da <sys_link+0xda>
    iunlockput(ip);
80105421:	83 ec 0c             	sub    $0xc,%esp
80105424:	53                   	push   %ebx
80105425:	e8 e6 c5 ff ff       	call   80101a10 <iunlockput>
    end_op();
8010542a:	e8 a1 d9 ff ff       	call   80102dd0 <end_op>
    return -1;
8010542f:	83 c4 10             	add    $0x10,%esp
80105432:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105437:	eb a1                	jmp    801053da <sys_link+0xda>
    end_op();
80105439:	e8 92 d9 ff ff       	call   80102dd0 <end_op>
    return -1;
8010543e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105443:	eb 95                	jmp    801053da <sys_link+0xda>
80105445:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80105454:	56                   	push   %esi
  if(argstr(0, &path) < 0)
80105455:	8d 45 c0             	lea    -0x40(%ebp),%eax
{
80105458:	53                   	push   %ebx
80105459:	83 ec 54             	sub    $0x54,%esp
  if(argstr(0, &path) < 0)
8010545c:	50                   	push   %eax
8010545d:	6a 00                	push   $0x0
8010545f:	e8 bc f9 ff ff       	call   80104e20 <argstr>
80105464:	83 c4 10             	add    $0x10,%esp
80105467:	85 c0                	test   %eax,%eax
80105469:	0f 88 7a 01 00 00    	js     801055e9 <sys_unlink+0x199>
  begin_op();
8010546f:	e8 ec d8 ff ff       	call   80102d60 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105474:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80105477:	83 ec 08             	sub    $0x8,%esp
8010547a:	53                   	push   %ebx
8010547b:	ff 75 c0             	push   -0x40(%ebp)
8010547e:	e8 3d cc ff ff       	call   801020c0 <nameiparent>
80105483:	83 c4 10             	add    $0x10,%esp
80105486:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80105489:	85 c0                	test   %eax,%eax
8010548b:	0f 84 62 01 00 00    	je     801055f3 <sys_unlink+0x1a3>
  ilock(dp);
80105491:	8b 7d b4             	mov    -0x4c(%ebp),%edi
...
8010549d:	58                   	pop    %eax
8010549e:	5a                   	pop    %edx
8010549f:	68 dc 7d 10 80       	push   $0x80107ddc
801054a4:	53                   	push   %ebx
801054a5:	e8 16 c8 ff ff       	call   80101cc0 <namecmp>
801054aa:	83 c4 10             	add    $0x10,%esp
801054ad:	85 c0                	test   %eax,%eax
801054af:	0f 84 fb 00 00 00    	je     801055b0 <sys_unlink+0x160>
801054b5:	83 ec 08             	sub    $0x8,%esp
801054b8:	68 db 7d 10 80       	push   $0x80107ddb
801054bd:	53                   	push   %ebx
801054be:	e8 fd c7 ff ff       	call   80101cc0 <namecmp>
801054c3:	83 c4 10             	add    $0x10,%esp
801054c6:	85 c0                	test   %eax,%eax
801054c8:	0f 84 e2 00 00 00    	je     801055b0 <sys_unlink+0x160>
  if((ip = dirlookup(dp, name, &off)) == 0)
801054ce:	83 ec 04             	sub    $0x4,%esp
801054d1:	8d 45 c4             	lea    -0x3c(%ebp),%eax
801054d4:	50                   	push   %eax
801054d5:	53                   	push   %ebx
801054d6:	57                   	push   %edi
801054d7:	e8 04 c8 ff ff       	call   80101ce0 <dirlookup>
801054dc:	83 c4 10             	add    $0x10,%esp
801054df:	89 c3                	mov    %eax,%ebx
801054e1:	85 c0                	test   %eax,%eax
801054e3:	0f 84 c7 00 00 00    	je     801055b0 <sys_unlink+0x160>
  ilock(ip);
...
801054f5:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
801054fa:	0f 8e 1c 01 00 00    	jle    8010561c <sys_unlink+0x1cc>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105500:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105505:	8d 7d d8             	lea    -0x28(%ebp),%edi
80105508:	74 66                	je     80105570 <sys_unlink+0x120>
  memset(&de, 0, sizeof(de));
8010550a:	83 ec 04             	sub    $0x4,%esp
8010550d:	6a 10                	push   $0x10
8010550f:	6a 00                	push   $0x0
80105511:	57                   	push   %edi
80105512:	e8 89 f5 ff ff       	call   80104aa0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105517:	6a 10                	push   $0x10
80105519:	ff 75 c4             	push   -0x3c(%ebp)
8010551c:	57                   	push   %edi
8010551d:	ff 75 b4             	push   -0x4c(%ebp)
80105520:	e8 6b c6 ff ff       	call   80101b90 <writei>
80105525:	83 c4 20             	add    $0x20,%esp
80105528:	83 f8 10             	cmp    $0x10,%eax
8010552b:	0f 85 de 00 00 00    	jne    8010560f <sys_unlink+0x1bf>
  if(ip->type == T_DIR){
80105531:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105536:	0f 84 94 00 00 00    	je     801055d0 <sys_unlink+0x180>
  iunlockput(dp);
8010553c:	83 ec 0c             	sub    $0xc,%esp
8010553f:	ff 75 b4             	push   -0x4c(%ebp)
80105542:	e8 c9 c4 ff ff       	call   80101a10 <iunlockput>
  ip->nlink--;
80105547:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010554c:	89 1c 24             	mov    %ebx,(%esp)
8010554f:	e8 7c c1 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
80105554:	89 1c 24             	mov    %ebx,(%esp)
80105557:	e8 b4 c4 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010555c:	e8 6f d8 ff ff       	call   80102dd0 <end_op>
  return 0;
80105561:	83 c4 10             	add    $0x10,%esp
80105564:	31 c0                	xor    %eax,%eax
}
80105566:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105569:	5b                   	pop    %ebx
8010556a:	5e                   	pop    %esi
8010556b:	5f                   	pop    %edi
8010556c:	5d                   	pop    %ebp
...
80105574:	76 94                	jbe    8010550a <sys_unlink+0xba>
80105576:	be 20 00 00 00       	mov    $0x20,%esi
8010557b:	eb 0b                	jmp    80105588 <sys_unlink+0x138>
8010557d:	8d 76 00             	lea    0x0(%esi),%esi
80105580:	83 c6 10             	add    $0x10,%esi
80105583:	3b 73 58             	cmp    0x58(%ebx),%esi
80105586:	73 82                	jae    8010550a <sys_unlink+0xba>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105588:	6a 10                	push   $0x10
8010558a:	56                   	push   %esi
8010558b:	57                   	push   %edi
8010558c:	53                   	push   %ebx
8010558d:	e8 fe c4 ff ff       	call   80101a90 <readi>
80105592:	83 c4 10             	add    $0x10,%esp
80105595:	83 f8 10             	cmp    $0x10,%eax
80105598:	75 68                	jne    80105602 <sys_unlink+0x1b2>
    if(de.inum != 0)
8010559a:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
8010559f:	74 df                	je     80105580 <sys_unlink+0x130>
    iunlockput(ip);
...
801055b3:	ff 75 b4             	push   -0x4c(%ebp)
801055b6:	e8 55 c4 ff ff       	call   80101a10 <iunlockput>
  end_op();
801055bb:	e8 10 d8 ff ff       	call   80102dd0 <end_op>
  return -1;
801055c0:	83 c4 10             	add    $0x10,%esp
801055c3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055c8:	eb 9c                	jmp    80105566 <sys_unlink+0x116>
801055ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    dp->nlink--;
801055d0:	8b 45 b4             	mov    -0x4c(%ebp),%eax
    iupdate(dp);
801055d3:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
801055d6:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
801055db:	50                   	push   %eax
801055dc:	e8 ef c0 ff ff       	call   801016d0 <iupdate>
801055e1:	83 c4 10             	add    $0x10,%esp
801055e4:	e9 53 ff ff ff       	jmp    8010553c <sys_unlink+0xec>
    return -1;
801055e9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055ee:	e9 73 ff ff ff       	jmp    80105566 <sys_unlink+0x116>
    end_op();
801055f3:	e8 d8 d7 ff ff       	call   80102dd0 <end_op>
    return -1;
801055f8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055fd:	e9 64 ff ff ff       	jmp    80105566 <sys_unlink+0x116>
      panic("isdirempty: readi");
80105602:	83 ec 0c             	sub    $0xc,%esp
80105605:	68 00 7e 10 80       	push   $0x80107e00
8010560a:	e8 71 ad ff ff       	call   80100380 <panic>
    panic("unlink: writei");
8010560f:	83 ec 0c             	sub    $0xc,%esp
80105612:	68 12 7e 10 80       	push   $0x80107e12
80105617:	e8 64 ad ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
8010561c:	83 ec 0c             	sub    $0xc,%esp
8010561f:	68 ee 7d 10 80       	push   $0x80107dee
80105624:	e8 57 ad ff ff       	call   80100380 <panic>
...
80105635:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
...
8010563f:	e8 dc f7 ff ff       	call   80104e20 <argstr>
80105644:	83 c4 10             	add    $0x10,%esp
80105647:	85 c0                	test   %eax,%eax
80105649:	0f 88 8e 00 00 00    	js     801056dd <sys_open+0xad>
8010564f:	83 ec 08             	sub    $0x8,%esp
80105652:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105655:	50                   	push   %eax
80105656:	6a 01                	push   $0x1
80105658:	e8 03 f7 ff ff       	call   80104d60 <argint>
8010565d:	83 c4 10             	add    $0x10,%esp
80105660:	85 c0                	test   %eax,%eax
80105662:	78 79                	js     801056dd <sys_open+0xad>
    return -1;

  begin_op();
80105664:	e8 f7 d6 ff ff       	call   80102d60 <begin_op>

  if(omode & O_CREATE){
80105669:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
8010566d:	75 79                	jne    801056e8 <sys_open+0xb8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80105672:	ff 75 e0             	push   -0x20(%ebp)
80105675:	e8 26 ca ff ff       	call   801020a0 <namei>
8010567a:	83 c4 10             	add    $0x10,%esp
8010567d:	89 c6                	mov    %eax,%esi
8010567f:	85 c0                	test   %eax,%eax
80105681:	0f 84 7e 00 00 00    	je     80105705 <sys_open+0xd5>
      end_op();
      return -1;
    }
    ilock(ip);
...
8010568b:	e8 f0 c0 ff ff       	call   80101780 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105690:	83 c4 10             	add    $0x10,%esp
80105693:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80105698:	0f 84 c2 00 00 00    	je     80105760 <sys_open+0x130>
      end_op();
      return -1;
    }
  }
...
8010569e:	e8 8d b7 ff ff       	call   80100e30 <filealloc>
801056a3:	89 c7                	mov    %eax,%edi
801056a5:	85 c0                	test   %eax,%eax
801056a7:	74 23                	je     801056cc <sys_open+0x9c>
  struct proc *curproc = myproc();
801056a9:	e8 d2 e2 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
801056ae:	31 db                	xor    %ebx,%ebx
    if(curproc->ofile[fd] == 0){
801056b0:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
801056b4:	85 d2                	test   %edx,%edx
801056b6:	74 60                	je     80105718 <sys_open+0xe8>
  for(fd = 0; fd < NOFILE; fd++){
801056b8:	83 c3 01             	add    $0x1,%ebx
801056bb:	83 fb 10             	cmp    $0x10,%ebx
801056be:	75 f0                	jne    801056b0 <sys_open+0x80>
    if(f)
      fileclose(f);
801056c0:	83 ec 0c             	sub    $0xc,%esp
801056c3:	57                   	push   %edi
801056c4:	e8 27 b8 ff ff       	call   80100ef0 <fileclose>
801056c9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
801056cc:	83 ec 0c             	sub    $0xc,%esp
801056cf:	56                   	push   %esi
801056d0:	e8 3b c3 ff ff       	call   80101a10 <iunlockput>
    end_op();
801056d5:	e8 f6 d6 ff ff       	call   80102dd0 <end_op>
    return -1;
801056da:	83 c4 10             	add    $0x10,%esp
801056dd:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801056e2:	eb 6d                	jmp    80105751 <sys_open+0x121>
801056e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ip = create(path, T_FILE, 0, 0);
801056e8:	83 ec 0c             	sub    $0xc,%esp
801056eb:	8b 45 e0             	mov    -0x20(%ebp),%eax
801056ee:	31 c9                	xor    %ecx,%ecx
801056f0:	ba 02 00 00 00       	mov    $0x2,%edx
801056f5:	6a 00                	push   $0x0
801056f7:	e8 14 f8 ff ff       	call   80104f10 <create>
    if(ip == 0){
801056fc:	83 c4 10             	add    $0x10,%esp
    ip = create(path, T_FILE, 0, 0);
801056ff:	89 c6                	mov    %eax,%esi
    if(ip == 0){
80105701:	85 c0                	test   %eax,%eax
80105703:	75 99                	jne    8010569e <sys_open+0x6e>
      end_op();
80105705:	e8 c6 d6 ff ff       	call   80102dd0 <end_op>
      return -1;
8010570a:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
8010570f:	eb 40                	jmp    80105751 <sys_open+0x121>
80105711:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  }
  iunlock(ip);
80105718:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
8010571b:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
8010571f:	56                   	push   %esi
80105720:	e8 3b c1 ff ff       	call   80101860 <iunlock>
  end_op();
80105725:	e8 a6 d6 ff ff       	call   80102dd0 <end_op>

  f->type = FD_INODE;
8010572a:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80105730:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105733:	83 c4 10             	add    $0x10,%esp
  f->ip = ip;
80105736:	89 77 10             	mov    %esi,0x10(%edi)
  f->readable = !(omode & O_WRONLY);
80105739:	89 d0                	mov    %edx,%eax
  f->off = 0;
8010573b:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
80105742:	f7 d0                	not    %eax
80105744:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105747:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
8010574a:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010574d:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
80105751:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105754:	89 d8                	mov    %ebx,%eax
80105756:	5b                   	pop    %ebx
80105757:	5e                   	pop    %esi
80105758:	5f                   	pop    %edi
80105759:	5d                   	pop    %ebp
...
80105765:	0f 84 33 ff ff ff    	je     8010569e <sys_open+0x6e>
8010576b:	e9 5c ff ff ff       	jmp    801056cc <sys_open+0x9c>
...
80105784:	e8 97 f6 ff ff       	call   80104e20 <argstr>
...
80105798:	ba 01 00 00 00       	mov    $0x1,%edx
8010579d:	6a 00                	push   $0x0
8010579f:	e8 6c f7 ff ff       	call   80104f10 <create>
...
801057af:	e8 5c c2 ff ff       	call   80101a10 <iunlockput>
  end_op();
801057b4:	e8 17 d6 ff ff       	call   80102dd0 <end_op>
  return 0;
...
801057d3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801057d6:	e8 85 d5 ff ff       	call   80102d60 <begin_op>
  if((argstr(0, &path)) < 0 ||
801057db:	83 ec 08             	sub    $0x8,%esp
801057de:	8d 45 ec             	lea    -0x14(%ebp),%eax
801057e1:	50                   	push   %eax
801057e2:	6a 00                	push   $0x0
801057e4:	e8 37 f6 ff ff       	call   80104e20 <argstr>
...
801057f9:	e8 62 f5 ff ff       	call   80104d60 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010580e:	e8 4d f5 ff ff       	call   80104d60 <argint>
     argint(1, &major) < 0 ||
...
8010582e:	e8 dd f6 ff ff       	call   80104f10 <create>
     argint(2, &minor) < 0 ||
...
8010583e:	e8 cd c1 ff ff       	call   80101a10 <iunlockput>
  end_op();
...
8010588f:	e8 0c c8 ff ff       	call   801020a0 <namei>
...
801058a1:	e8 da be ff ff       	call   80101780 <ilock>
  if(ip->type != T_DIR){
...
801058b4:	e8 a7 bf ff ff       	call   80101860 <iunlock>
  iput(curproc->cwd);
801058b9:	58                   	pop    %eax
801058ba:	ff 76 6c             	push   0x6c(%esi)
801058bd:	e8 ee bf ff ff       	call   801018b0 <iput>
  end_op();
801058c2:	e8 09 d5 ff ff       	call   80102dd0 <end_op>
  curproc->cwd = ip;
...
801058e4:	e8 27 c1 ff ff       	call   80101a10 <iunlockput>
    end_op();
801058e9:	e8 e2 d4 ff ff       	call   80102dd0 <end_op>
    return -1;
...
80105915:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
{
...
80105925:	e8 f6 f4 ff ff       	call   80104e20 <argstr>
...
80105938:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
8010593e:	50                   	push   %eax
8010593f:	6a 01                	push   $0x1
80105941:	e8 1a f4 ff ff       	call   80104d60 <argint>
...
80105950:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
  for(i=0;; i++){
...
80105960:	e8 3b f1 ff ff       	call   80104aa0 <memset>
...
80105973:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
80105979:	8d 3c 9d 00 00 00 00 	lea    0x0(,%ebx,4),%edi
80105980:	50                   	push   %eax
80105981:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80105987:	01 f8                	add    %edi,%eax
80105989:	50                   	push   %eax
8010598a:	e8 41 f3 ff ff       	call   80104cd0 <fetchint>
8010598f:	83 c4 10             	add    $0x10,%esp
80105992:	85 c0                	test   %eax,%eax
80105994:	78 26                	js     801059bc <sys_exec+0xac>
      return -1;
    if(uarg == 0){
80105996:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
8010599c:	85 c0                	test   %eax,%eax
8010599e:	74 30                	je     801059d0 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
801059a0:	83 ec 08             	sub    $0x8,%esp
801059a3:	8d 14 3e             	lea    (%esi,%edi,1),%edx
801059a6:	52                   	push   %edx
801059a7:	50                   	push   %eax
801059a8:	e8 63 f3 ff ff       	call   80104d10 <fetchstr>
801059ad:	83 c4 10             	add    $0x10,%esp
801059b0:	85 c0                	test   %eax,%eax
801059b2:	78 08                	js     801059bc <sys_exec+0xac>
  for(i=0;; i++){
801059b4:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
801059b7:	83 fb 20             	cmp    $0x20,%ebx
801059ba:	75 b4                	jne    80105970 <sys_exec+0x60>
      return -1;
  }
...
801059c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      argv[i] = 0;
801059d0:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
801059d7:	00 00 00 00 
  return exec(path, argv);
801059db:	83 ec 08             	sub    $0x8,%esp
801059de:	56                   	push   %esi
801059df:	ff b5 5c ff ff ff    	push   -0xa4(%ebp)
801059e5:	e8 c6 b0 ff ff       	call   80100ab0 <exec>
...
80105a05:	8d 45 dc             	lea    -0x24(%ebp),%eax
{
...
80105a28:	e8 03 da ff ff       	call   80103430 <pipealloc>
...
80105a34:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
80105a37:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105a39:	e8 42 df ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80105a3e:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[fd] == 0){
80105a40:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
80105a44:	85 f6                	test   %esi,%esi
80105a46:	74 28                	je     80105a70 <sys_pipe+0x70>
  for(fd = 0; fd < NOFILE; fd++){
...
80105a53:	ff 75 e0             	push   -0x20(%ebp)
80105a56:	e8 95 b4 ff ff       	call   80100ef0 <fileclose>
    fileclose(wf);
80105a5b:	58                   	pop    %eax
80105a5c:	ff 75 e4             	push   -0x1c(%ebp)
80105a5f:	e8 8c b4 ff ff       	call   80100ef0 <fileclose>
    return -1;
80105a64:	83 c4 10             	add    $0x10,%esp
80105a67:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a6c:	eb 53                	jmp    80105ac1 <sys_pipe+0xc1>
...
80105a77:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105a7a:	e8 01 df ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
{
  return fork();
80105ad0:	e9 4b e0 ff ff       	jmp    80103b20 <fork>
...
80105ae3:	83 ec 08             	sub    $0x8,%esp
  exit();
80105ae6:	e8 a5 e5 ff ff       	call   80104090 <exit>
...
{
  return wait();
80105af0:	e9 0b e8 ff ff       	jmp    80104300 <wait>
...
80105b1b:	ff 75 f4             	push   -0xc(%ebp)
80105b1e:	e8 7d ea ff ff       	call   801045a0 <kill>
...
80105b43:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105b46:	e8 35 de ff ff       	call   80103980 <myproc>
80105b4b:	8b 40 14             	mov    0x14(%eax),%eax
}
80105b4e:	c9                   	leave  
80105b4f:	c3                   	ret    
...
80105b5d:	e8 fe f1 ff ff       	call   80104d60 <argint>
80105b62:	83 c4 10             	add    $0x10,%esp
80105b65:	85 c0                	test   %eax,%eax
80105b67:	78 27                	js     80105b90 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
...
80105b6e:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80105b71:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105b73:	ff 75 f4             	push   -0xc(%ebp)
80105b76:	e8 25 df ff ff       	call   80103aa0 <growproc>
80105b7b:	83 c4 10             	add    $0x10,%esp
80105b7e:	85 c0                	test   %eax,%eax
80105b80:	78 0e                	js     80105b90 <sys_sbrk+0x40>
    return -1;
  return addr;
}
80105b82:	89 d8                	mov    %ebx,%eax
80105b84:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105b87:	c9                   	leave  
80105b88:	c3                   	ret    
80105b89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    return -1;
80105b90:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105b95:	eb eb                	jmp    80105b82 <sys_sbrk+0x32>
...
80105bad:	e8 ae f1 ff ff       	call   80104d60 <argint>
80105bb2:	83 c4 10             	add    $0x10,%esp
80105bb5:	85 c0                	test   %eax,%eax
80105bb7:	0f 88 8a 00 00 00    	js     80105c47 <sys_sleep+0xa7>
    return -1;
  acquire(&tickslock);
80105bbd:	83 ec 0c             	sub    $0xc,%esp
80105bc0:	68 80 50 11 80       	push   $0x80115080
80105bc5:	e8 16 ee ff ff       	call   801049e0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105bca:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105bcd:	8b 1d 60 50 11 80    	mov    0x80115060,%ebx
  while(ticks - ticks0 < n){
80105bd3:	83 c4 10             	add    $0x10,%esp
80105bd6:	85 d2                	test   %edx,%edx
80105bd8:	75 27                	jne    80105c01 <sys_sleep+0x61>
80105bda:	eb 54                	jmp    80105c30 <sys_sleep+0x90>
...
80105be3:	68 80 50 11 80       	push   $0x80115080
80105be8:	68 60 50 11 80       	push   $0x80115060
80105bed:	e8 8e e8 ff ff       	call   80104480 <sleep>
  while(ticks - ticks0 < n){
80105bf2:	a1 60 50 11 80       	mov    0x80115060,%eax
80105bf7:	83 c4 10             	add    $0x10,%esp
80105bfa:	29 d8                	sub    %ebx,%eax
80105bfc:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80105bff:	73 2f                	jae    80105c30 <sys_sleep+0x90>
    if(myproc()->killed){
80105c01:	e8 7a dd ff ff       	call   80103980 <myproc>
80105c06:	8b 40 28             	mov    0x28(%eax),%eax
80105c09:	85 c0                	test   %eax,%eax
80105c0b:	74 d3                	je     80105be0 <sys_sleep+0x40>
      release(&tickslock);
80105c0d:	83 ec 0c             	sub    $0xc,%esp
80105c10:	68 80 50 11 80       	push   $0x80115080
80105c15:	e8 66 ed ff ff       	call   80104980 <release>
  }
  release(&tickslock);
  return 0;
}
80105c1a:	8b 5d fc             	mov    -0x4(%ebp),%ebx
      return -1;
...
80105c38:	e8 43 ed ff ff       	call   80104980 <release>
  return 0;
80105c3d:	83 c4 10             	add    $0x10,%esp
80105c40:	31 c0                	xor    %eax,%eax
}
80105c42:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105c45:	c9                   	leave  
80105c46:	c3                   	ret    
    return -1;
80105c47:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c4c:	eb f4                	jmp    80105c42 <sys_sleep+0xa2>
...
80105c54:	83 ec 10             	sub    $0x10,%esp
  uint xticks;

  acquire(&tickslock);
80105c57:	68 80 50 11 80       	push   $0x80115080
80105c5c:	e8 7f ed ff ff       	call   801049e0 <acquire>
  xticks = ticks;
80105c61:	8b 1d 60 50 11 80    	mov    0x80115060,%ebx
  release(&tickslock);
80105c67:	c7 04 24 80 50 11 80 	movl   $0x80115080,(%esp)
80105c6e:	e8 0d ed ff ff       	call   80104980 <release>
  return xticks;
}
80105c73:	89 d8                	mov    %ebx,%eax
...
80105d2d:	54                   	push   %esp
  call trap
80105d2e:	e8 cd 00 00 00       	call   80105e00 <trap>
  addl $4, %esp
...
80105d67:	c7 04 c5 c2 50 11 80 	movl   $0x8e000008,-0x7feeaf3e(,%eax,8)
80105d6e:	08 00 00 8e 
80105d72:	66 89 14 c5 c0 50 11 	mov    %dx,-0x7feeaf40(,%eax,8)
80105d79:	80 
80105d7a:	c1 ea 10             	shr    $0x10,%edx
80105d7d:	66 89 14 c5 c6 50 11 	mov    %dx,-0x7feeaf3a(,%eax,8)
80105d84:	80 
  for(i = 0; i < 256; i++)
...
80105d97:	c7 05 c2 52 11 80 08 	movl   $0xef000008,0x801152c2
80105d9e:	00 00 ef 
  initlock(&tickslock, "time");
80105da1:	68 21 7e 10 80       	push   $0x80107e21
80105da6:	68 80 50 11 80       	push   $0x80115080
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105dab:	66 a3 c0 52 11 80    	mov    %ax,0x801152c0
80105db1:	c1 e8 10             	shr    $0x10,%eax
80105db4:	66 a3 c6 52 11 80    	mov    %ax,0x801152c6
  initlock(&tickslock, "time");
...
80105ddb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105ddf:	b8 c0 50 11 80       	mov    $0x801150c0,%eax
...
80105e24:	ff 24 85 c8 7e 10 80 	jmp    *-0x7fef8138(,%eax,4)
...
80105e43:	e8 38 db ff ff       	call   80103980 <myproc>
80105e48:	8b 50 28             	mov    0x28(%eax),%edx
...
80105e6e:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
80105e72:	0f 84 b8 00 00 00    	je     80105f30 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e78:	e8 03 db ff ff       	call   80103980 <myproc>
...
80105eb0:	e8 cb da ff ff       	call   80103980 <myproc>
...
80105ed0:	e8 8b da ff ff       	call   80103960 <cpuid>
...
80105f05:	68 84 7e 10 80       	push   $0x80107e84
80105f0a:	e8 91 a7 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105f0f:	83 c4 20             	add    $0x20,%esp
80105f12:	e8 69 da ff ff       	call   80103980 <myproc>
80105f17:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f1e:	e8 5d da ff ff       	call   80103980 <myproc>
...
80105f34:	0f 85 3e ff ff ff    	jne    80105e78 <trap+0x78>
    yield();
80105f3a:	e8 f1 e4 ff ff       	call   80104430 <yield>
...
80105f4f:	e8 0c da ff ff       	call   80103960 <cpuid>
80105f54:	57                   	push   %edi
80105f55:	56                   	push   %esi
80105f56:	50                   	push   %eax
80105f57:	68 2c 7e 10 80       	push   $0x80107e2c
...
80105f66:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f69:	e8 12 da ff ff       	call   80103980 <myproc>
...
80105f85:	8b 70 28             	mov    0x28(%eax),%esi
...
80105f95:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
80105f98:	e8 03 ef ff ff       	call   80104ea0 <syscall>
    if(myproc()->killed)
80105f9d:	e8 de d9 ff ff       	call   80103980 <myproc>
80105fa2:	8b 48 28             	mov    0x28(%eax),%ecx
...
80105fe5:	e8 26 c9 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105fea:	e8 91 d9 ff ff       	call   80103980 <myproc>
...
80105ffc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80106000:	e8 5b d9 ff ff       	call   80103960 <cpuid>
80106005:	85 c0                	test   %eax,%eax
80106007:	0f 85 28 fe ff ff    	jne    80105e35 <trap+0x35>
      acquire(&tickslock);
8010600d:	83 ec 0c             	sub    $0xc,%esp
80106010:	68 80 50 11 80       	push   $0x80115080
80106015:	e8 c6 e9 ff ff       	call   801049e0 <acquire>
      wakeup(&ticks);
8010601a:	c7 04 24 60 50 11 80 	movl   $0x80115060,(%esp)
      ticks++;
80106021:	83 05 60 50 11 80 01 	addl   $0x1,0x80115060
      wakeup(&ticks);
80106028:	e8 13 e5 ff ff       	call   80104540 <wakeup>
      release(&tickslock);
8010602d:	c7 04 24 80 50 11 80 	movl   $0x80115080,(%esp)
...
{
  if(!uart)
80106090:	a1 c0 58 11 80       	mov    0x801158c0,%eax
...
80106117:	74 78                	je     80106191 <uartinit+0xd1>
  uart = 1;
80106119:	c7 05 c0 58 11 80 01 	movl   $0x1,0x801158c0
80106120:	00 00 00 
...
8010612c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
8010612f:	bf 48 7f 10 80       	mov    $0x80107f48,%edi
...
80106149:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80106150:	a1 c0 58 11 80       	mov    0x801158c0,%eax
...
801061a0 <uartputc>:
  if(!uart)
801061a0:	a1 c0 58 11 80       	mov    0x801158c0,%eax
...
80106217:	6a 00                	push   $0x0
  jmp alltraps
80106219:	e9 00 fb ff ff       	jmp    80105d1e <alltraps>
...
80106220:	6a 01                	push   $0x1
  jmp alltraps
80106222:	e9 f7 fa ff ff       	jmp    80105d1e <alltraps>
...
80106229:	6a 02                	push   $0x2
  jmp alltraps
8010622b:	e9 ee fa ff ff       	jmp    80105d1e <alltraps>
...
80106232:	6a 03                	push   $0x3
  jmp alltraps
80106234:	e9 e5 fa ff ff       	jmp    80105d1e <alltraps>
...
8010623b:	6a 04                	push   $0x4
  jmp alltraps
8010623d:	e9 dc fa ff ff       	jmp    80105d1e <alltraps>
...
80106244:	6a 05                	push   $0x5
  jmp alltraps
80106246:	e9 d3 fa ff ff       	jmp    80105d1e <alltraps>
...
8010624d:	6a 06                	push   $0x6
  jmp alltraps
8010624f:	e9 ca fa ff ff       	jmp    80105d1e <alltraps>
...
8010625d:	6a 08                	push   $0x8
  jmp alltraps
8010625f:	e9 ba fa ff ff       	jmp    80105d1e <alltraps>
...
80106266:	6a 09                	push   $0x9
  jmp alltraps
80106268:	e9 b1 fa ff ff       	jmp    80105d1e <alltraps>
...
8010626d:	6a 0a                	push   $0xa
  jmp alltraps
8010626f:	e9 aa fa ff ff       	jmp    80105d1e <alltraps>
...
80106274:	6a 0b                	push   $0xb
  jmp alltraps
80106276:	e9 a3 fa ff ff       	jmp    80105d1e <alltraps>
...
8010627b:	6a 0c                	push   $0xc
  jmp alltraps
8010627d:	e9 9c fa ff ff       	jmp    80105d1e <alltraps>
...
80106282:	6a 0d                	push   $0xd
  jmp alltraps
80106284:	e9 95 fa ff ff       	jmp    80105d1e <alltraps>
...
80106289:	6a 0e                	push   $0xe
  jmp alltraps
8010628b:	e9 8e fa ff ff       	jmp    80105d1e <alltraps>
...
80106292:	6a 0f                	push   $0xf
  jmp alltraps
80106294:	e9 85 fa ff ff       	jmp    80105d1e <alltraps>
...
8010629b:	6a 10                	push   $0x10
  jmp alltraps
8010629d:	e9 7c fa ff ff       	jmp    80105d1e <alltraps>
...
801062a2:	6a 11                	push   $0x11
  jmp alltraps
801062a4:	e9 75 fa ff ff       	jmp    80105d1e <alltraps>
...
801062ab:	6a 12                	push   $0x12
  jmp alltraps
801062ad:	e9 6c fa ff ff       	jmp    80105d1e <alltraps>
...
801062b4:	6a 13                	push   $0x13
  jmp alltraps
801062b6:	e9 63 fa ff ff       	jmp    80105d1e <alltraps>
...
801062bd:	6a 14                	push   $0x14
  jmp alltraps
801062bf:	e9 5a fa ff ff       	jmp    80105d1e <alltraps>
...
801062c6:	6a 15                	push   $0x15
  jmp alltraps
801062c8:	e9 51 fa ff ff       	jmp    80105d1e <alltraps>
...
801062cf:	6a 16                	push   $0x16
  jmp alltraps
801062d1:	e9 48 fa ff ff       	jmp    80105d1e <alltraps>
...
801062d8:	6a 17                	push   $0x17
  jmp alltraps
801062da:	e9 3f fa ff ff       	jmp    80105d1e <alltraps>
...
801062e1:	6a 18                	push   $0x18
  jmp alltraps
801062e3:	e9 36 fa ff ff       	jmp    80105d1e <alltraps>
...
801062ea:	6a 19                	push   $0x19
  jmp alltraps
801062ec:	e9 2d fa ff ff       	jmp    80105d1e <alltraps>
...
801062f3:	6a 1a                	push   $0x1a
  jmp alltraps
801062f5:	e9 24 fa ff ff       	jmp    80105d1e <alltraps>
...
801062fc:	6a 1b                	push   $0x1b
  jmp alltraps
801062fe:	e9 1b fa ff ff       	jmp    80105d1e <alltraps>
...
80106305:	6a 1c                	push   $0x1c
  jmp alltraps
80106307:	e9 12 fa ff ff       	jmp    80105d1e <alltraps>
...
8010630e:	6a 1d                	push   $0x1d
  jmp alltraps
80106310:	e9 09 fa ff ff       	jmp    80105d1e <alltraps>
...
80106317:	6a 1e                	push   $0x1e
  jmp alltraps
80106319:	e9 00 fa ff ff       	jmp    80105d1e <alltraps>
...
80106320:	6a 1f                	push   $0x1f
  jmp alltraps
80106322:	e9 f7 f9 ff ff       	jmp    80105d1e <alltraps>
...
80106329:	6a 20                	push   $0x20
  jmp alltraps
8010632b:	e9 ee f9 ff ff       	jmp    80105d1e <alltraps>
...
80106332:	6a 21                	push   $0x21
  jmp alltraps
80106334:	e9 e5 f9 ff ff       	jmp    80105d1e <alltraps>
...
8010633b:	6a 22                	push   $0x22
  jmp alltraps
8010633d:	e9 dc f9 ff ff       	jmp    80105d1e <alltraps>
...
80106344:	6a 23                	push   $0x23
  jmp alltraps
80106346:	e9 d3 f9 ff ff       	jmp    80105d1e <alltraps>
...
8010634d:	6a 24                	push   $0x24
  jmp alltraps
8010634f:	e9 ca f9 ff ff       	jmp    80105d1e <alltraps>
...
80106356:	6a 25                	push   $0x25
  jmp alltraps
80106358:	e9 c1 f9 ff ff       	jmp    80105d1e <alltraps>
...
8010635f:	6a 26                	push   $0x26
  jmp alltraps
80106361:	e9 b8 f9 ff ff       	jmp    80105d1e <alltraps>
...
80106368:	6a 27                	push   $0x27
  jmp alltraps
8010636a:	e9 af f9 ff ff       	jmp    80105d1e <alltraps>
...
80106371:	6a 28                	push   $0x28
  jmp alltraps
80106373:	e9 a6 f9 ff ff       	jmp    80105d1e <alltraps>
...
8010637a:	6a 29                	push   $0x29
  jmp alltraps
8010637c:	e9 9d f9 ff ff       	jmp    80105d1e <alltraps>
...
80106383:	6a 2a                	push   $0x2a
  jmp alltraps
80106385:	e9 94 f9 ff ff       	jmp    80105d1e <alltraps>
...
8010638c:	6a 2b                	push   $0x2b
  jmp alltraps
8010638e:	e9 8b f9 ff ff       	jmp    80105d1e <alltraps>
...
80106395:	6a 2c                	push   $0x2c
  jmp alltraps
80106397:	e9 82 f9 ff ff       	jmp    80105d1e <alltraps>
...
8010639e:	6a 2d                	push   $0x2d
  jmp alltraps
801063a0:	e9 79 f9 ff ff       	jmp    80105d1e <alltraps>
...
801063a7:	6a 2e                	push   $0x2e
  jmp alltraps
801063a9:	e9 70 f9 ff ff       	jmp    80105d1e <alltraps>
...
801063b0:	6a 2f                	push   $0x2f
  jmp alltraps
801063b2:	e9 67 f9 ff ff       	jmp    80105d1e <alltraps>
...
801063b9:	6a 30                	push   $0x30
  jmp alltraps
801063bb:	e9 5e f9 ff ff       	jmp    80105d1e <alltraps>
...
801063c2:	6a 31                	push   $0x31
  jmp alltraps
801063c4:	e9 55 f9 ff ff       	jmp    80105d1e <alltraps>
...
801063cb:	6a 32                	push   $0x32
  jmp alltraps
801063cd:	e9 4c f9 ff ff       	jmp    80105d1e <alltraps>
...
801063d4:	6a 33                	push   $0x33
  jmp alltraps
801063d6:	e9 43 f9 ff ff       	jmp    80105d1e <alltraps>
...
801063dd:	6a 34                	push   $0x34
  jmp alltraps
801063df:	e9 3a f9 ff ff       	jmp    80105d1e <alltraps>
...
801063e6:	6a 35                	push   $0x35
  jmp alltraps
801063e8:	e9 31 f9 ff ff       	jmp    80105d1e <alltraps>
...
801063ef:	6a 36                	push   $0x36
  jmp alltraps
801063f1:	e9 28 f9 ff ff       	jmp    80105d1e <alltraps>
...
801063f8:	6a 37                	push   $0x37
  jmp alltraps
801063fa:	e9 1f f9 ff ff       	jmp    80105d1e <alltraps>
...
80106401:	6a 38                	push   $0x38
  jmp alltraps
80106403:	e9 16 f9 ff ff       	jmp    80105d1e <alltraps>
...
8010640a:	6a 39                	push   $0x39
  jmp alltraps
8010640c:	e9 0d f9 ff ff       	jmp    80105d1e <alltraps>
...
80106413:	6a 3a                	push   $0x3a
  jmp alltraps
80106415:	e9 04 f9 ff ff       	jmp    80105d1e <alltraps>
...
8010641c:	6a 3b                	push   $0x3b
  jmp alltraps
8010641e:	e9 fb f8 ff ff       	jmp    80105d1e <alltraps>
...
80106425:	6a 3c                	push   $0x3c
  jmp alltraps
80106427:	e9 f2 f8 ff ff       	jmp    80105d1e <alltraps>
...
8010642e:	6a 3d                	push   $0x3d
  jmp alltraps
80106430:	e9 e9 f8 ff ff       	jmp    80105d1e <alltraps>
...
80106437:	6a 3e                	push   $0x3e
  jmp alltraps
80106439:	e9 e0 f8 ff ff       	jmp    80105d1e <alltraps>
...
80106440:	6a 3f                	push   $0x3f
  jmp alltraps
80106442:	e9 d7 f8 ff ff       	jmp    80105d1e <alltraps>
...
80106449:	6a 40                	push   $0x40
  jmp alltraps
8010644b:	e9 ce f8 ff ff       	jmp    80105d1e <alltraps>
...
80106452:	6a 41                	push   $0x41
  jmp alltraps
80106454:	e9 c5 f8 ff ff       	jmp    80105d1e <alltraps>
...
8010645b:	6a 42                	push   $0x42
  jmp alltraps
8010645d:	e9 bc f8 ff ff       	jmp    80105d1e <alltraps>
...
80106464:	6a 43                	push   $0x43
  jmp alltraps
80106466:	e9 b3 f8 ff ff       	jmp    80105d1e <alltraps>
...
8010646d:	6a 44                	push   $0x44
  jmp alltraps
8010646f:	e9 aa f8 ff ff       	jmp    80105d1e <alltraps>
...
80106476:	6a 45                	push   $0x45
  jmp alltraps
80106478:	e9 a1 f8 ff ff       	jmp    80105d1e <alltraps>
...
8010647f:	6a 46                	push   $0x46
  jmp alltraps
80106481:	e9 98 f8 ff ff       	jmp    80105d1e <alltraps>
...
80106488:	6a 47                	push   $0x47
  jmp alltraps
8010648a:	e9 8f f8 ff ff       	jmp    80105d1e <alltraps>
...
80106491:	6a 48                	push   $0x48
  jmp alltraps
80106493:	e9 86 f8 ff ff       	jmp    80105d1e <alltraps>
...
8010649a:	6a 49                	push   $0x49
  jmp alltraps
8010649c:	e9 7d f8 ff ff       	jmp    80105d1e <alltraps>
...
801064a3:	6a 4a                	push   $0x4a
  jmp alltraps
801064a5:	e9 74 f8 ff ff       	jmp    80105d1e <alltraps>
...
801064ac:	6a 4b                	push   $0x4b
  jmp alltraps
801064ae:	e9 6b f8 ff ff       	jmp    80105d1e <alltraps>
...
801064b5:	6a 4c                	push   $0x4c
  jmp alltraps
801064b7:	e9 62 f8 ff ff       	jmp    80105d1e <alltraps>
...
801064be:	6a 4d                	push   $0x4d
  jmp alltraps
801064c0:	e9 59 f8 ff ff       	jmp    80105d1e <alltraps>
...
801064c7:	6a 4e                	push   $0x4e
  jmp alltraps
801064c9:	e9 50 f8 ff ff       	jmp    80105d1e <alltraps>
...
801064d0:	6a 4f                	push   $0x4f
  jmp alltraps
801064d2:	e9 47 f8 ff ff       	jmp    80105d1e <alltraps>
...
801064d9:	6a 50                	push   $0x50
  jmp alltraps
801064db:	e9 3e f8 ff ff       	jmp    80105d1e <alltraps>
...
801064e2:	6a 51                	push   $0x51
  jmp alltraps
801064e4:	e9 35 f8 ff ff       	jmp    80105d1e <alltraps>
...
801064eb:	6a 52                	push   $0x52
  jmp alltraps
801064ed:	e9 2c f8 ff ff       	jmp    80105d1e <alltraps>
...
801064f4:	6a 53                	push   $0x53
  jmp alltraps
801064f6:	e9 23 f8 ff ff       	jmp    80105d1e <alltraps>
...
801064fd:	6a 54                	push   $0x54
  jmp alltraps
801064ff:	e9 1a f8 ff ff       	jmp    80105d1e <alltraps>
...
80106506:	6a 55                	push   $0x55
  jmp alltraps
80106508:	e9 11 f8 ff ff       	jmp    80105d1e <alltraps>
...
8010650f:	6a 56                	push   $0x56
  jmp alltraps
80106511:	e9 08 f8 ff ff       	jmp    80105d1e <alltraps>
...
80106518:	6a 57                	push   $0x57
  jmp alltraps
8010651a:	e9 ff f7 ff ff       	jmp    80105d1e <alltraps>
...
80106521:	6a 58                	push   $0x58
  jmp alltraps
80106523:	e9 f6 f7 ff ff       	jmp    80105d1e <alltraps>
...
8010652a:	6a 59                	push   $0x59
  jmp alltraps
8010652c:	e9 ed f7 ff ff       	jmp    80105d1e <alltraps>
...
80106533:	6a 5a                	push   $0x5a
  jmp alltraps
80106535:	e9 e4 f7 ff ff       	jmp    80105d1e <alltraps>
...
8010653c:	6a 5b                	push   $0x5b
  jmp alltraps
8010653e:	e9 db f7 ff ff       	jmp    80105d1e <alltraps>
...
80106545:	6a 5c                	push   $0x5c
  jmp alltraps
80106547:	e9 d2 f7 ff ff       	jmp    80105d1e <alltraps>
...
8010654e:	6a 5d                	push   $0x5d
  jmp alltraps
80106550:	e9 c9 f7 ff ff       	jmp    80105d1e <alltraps>
...
80106557:	6a 5e                	push   $0x5e
  jmp alltraps
80106559:	e9 c0 f7 ff ff       	jmp    80105d1e <alltraps>
...
80106560:	6a 5f                	push   $0x5f
  jmp alltraps
80106562:	e9 b7 f7 ff ff       	jmp    80105d1e <alltraps>
...
80106569:	6a 60                	push   $0x60
  jmp alltraps
8010656b:	e9 ae f7 ff ff       	jmp    80105d1e <alltraps>
...
80106572:	6a 61                	push   $0x61
  jmp alltraps
80106574:	e9 a5 f7 ff ff       	jmp    80105d1e <alltraps>
...
8010657b:	6a 62                	push   $0x62
  jmp alltraps
8010657d:	e9 9c f7 ff ff       	jmp    80105d1e <alltraps>
...
80106584:	6a 63                	push   $0x63
  jmp alltraps
80106586:	e9 93 f7 ff ff       	jmp    80105d1e <alltraps>
...
8010658d:	6a 64                	push   $0x64
  jmp alltraps
8010658f:	e9 8a f7 ff ff       	jmp    80105d1e <alltraps>
...
80106596:	6a 65                	push   $0x65
  jmp alltraps
80106598:	e9 81 f7 ff ff       	jmp    80105d1e <alltraps>
...
8010659f:	6a 66                	push   $0x66
  jmp alltraps
801065a1:	e9 78 f7 ff ff       	jmp    80105d1e <alltraps>
...
801065a8:	6a 67                	push   $0x67
  jmp alltraps
801065aa:	e9 6f f7 ff ff       	jmp    80105d1e <alltraps>
...
801065b1:	6a 68                	push   $0x68
  jmp alltraps
801065b3:	e9 66 f7 ff ff       	jmp    80105d1e <alltraps>
...
801065ba:	6a 69                	push   $0x69
  jmp alltraps
801065bc:	e9 5d f7 ff ff       	jmp    80105d1e <alltraps>
...
801065c3:	6a 6a                	push   $0x6a
  jmp alltraps
801065c5:	e9 54 f7 ff ff       	jmp    80105d1e <alltraps>
...
801065cc:	6a 6b                	push   $0x6b
  jmp alltraps
801065ce:	e9 4b f7 ff ff       	jmp    80105d1e <alltraps>
...
801065d5:	6a 6c                	push   $0x6c
  jmp alltraps
801065d7:	e9 42 f7 ff ff       	jmp    80105d1e <alltraps>
...
801065de:	6a 6d                	push   $0x6d
  jmp alltraps
801065e0:	e9 39 f7 ff ff       	jmp    80105d1e <alltraps>
...
801065e7:	6a 6e                	push   $0x6e
  jmp alltraps
801065e9:	e9 30 f7 ff ff       	jmp    80105d1e <alltraps>
...
801065f0:	6a 6f                	push   $0x6f
  jmp alltraps
801065f2:	e9 27 f7 ff ff       	jmp    80105d1e <alltraps>
...
801065f9:	6a 70                	push   $0x70
  jmp alltraps
801065fb:	e9 1e f7 ff ff       	jmp    80105d1e <alltraps>
...
80106602:	6a 71                	push   $0x71
  jmp alltraps
80106604:	e9 15 f7 ff ff       	jmp    80105d1e <alltraps>
...
8010660b:	6a 72                	push   $0x72
  jmp alltraps
8010660d:	e9 0c f7 ff ff       	jmp    80105d1e <alltraps>
...
80106614:	6a 73                	push   $0x73
  jmp alltraps
80106616:	e9 03 f7 ff ff       	jmp    80105d1e <alltraps>
...
8010661d:	6a 74                	push   $0x74
  jmp alltraps
8010661f:	e9 fa f6 ff ff       	jmp    80105d1e <alltraps>
...
80106626:	6a 75                	push   $0x75
  jmp alltraps
80106628:	e9 f1 f6 ff ff       	jmp    80105d1e <alltraps>
...
8010662f:	6a 76                	push   $0x76
  jmp alltraps
80106631:	e9 e8 f6 ff ff       	jmp    80105d1e <alltraps>
...
80106638:	6a 77                	push   $0x77
  jmp alltraps
8010663a:	e9 df f6 ff ff       	jmp    80105d1e <alltraps>
...
80106641:	6a 78                	push   $0x78
  jmp alltraps
80106643:	e9 d6 f6 ff ff       	jmp    80105d1e <alltraps>
...
8010664a:	6a 79                	push   $0x79
  jmp alltraps
8010664c:	e9 cd f6 ff ff       	jmp    80105d1e <alltraps>
...
80106653:	6a 7a                	push   $0x7a
  jmp alltraps
80106655:	e9 c4 f6 ff ff       	jmp    80105d1e <alltraps>
...
8010665c:	6a 7b                	push   $0x7b
  jmp alltraps
8010665e:	e9 bb f6 ff ff       	jmp    80105d1e <alltraps>
...
80106665:	6a 7c                	push   $0x7c
  jmp alltraps
80106667:	e9 b2 f6 ff ff       	jmp    80105d1e <alltraps>
...
8010666e:	6a 7d                	push   $0x7d
  jmp alltraps
80106670:	e9 a9 f6 ff ff       	jmp    80105d1e <alltraps>
...
80106677:	6a 7e                	push   $0x7e
  jmp alltraps
80106679:	e9 a0 f6 ff ff       	jmp    80105d1e <alltraps>
...
80106680:	6a 7f                	push   $0x7f
  jmp alltraps
80106682:	e9 97 f6 ff ff       	jmp    80105d1e <alltraps>
...
80106689:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010668e:	e9 8b f6 ff ff       	jmp    80105d1e <alltraps>
...
80106695:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010669a:	e9 7f f6 ff ff       	jmp    80105d1e <alltraps>
...
801066a1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801066a6:	e9 73 f6 ff ff       	jmp    80105d1e <alltraps>
...
801066ad:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801066b2:	e9 67 f6 ff ff       	jmp    80105d1e <alltraps>
...
801066b9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801066be:	e9 5b f6 ff ff       	jmp    80105d1e <alltraps>
...
801066c5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801066ca:	e9 4f f6 ff ff       	jmp    80105d1e <alltraps>
...
801066d1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801066d6:	e9 43 f6 ff ff       	jmp    80105d1e <alltraps>
...
801066dd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801066e2:	e9 37 f6 ff ff       	jmp    80105d1e <alltraps>
...
801066e9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801066ee:	e9 2b f6 ff ff       	jmp    80105d1e <alltraps>
...
801066f5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801066fa:	e9 1f f6 ff ff       	jmp    80105d1e <alltraps>
...
80106701:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106706:	e9 13 f6 ff ff       	jmp    80105d1e <alltraps>
...
8010670d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106712:	e9 07 f6 ff ff       	jmp    80105d1e <alltraps>
...
80106719:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010671e:	e9 fb f5 ff ff       	jmp    80105d1e <alltraps>
...
80106725:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010672a:	e9 ef f5 ff ff       	jmp    80105d1e <alltraps>
...
80106731:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106736:	e9 e3 f5 ff ff       	jmp    80105d1e <alltraps>
...
8010673d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106742:	e9 d7 f5 ff ff       	jmp    80105d1e <alltraps>
...
80106749:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010674e:	e9 cb f5 ff ff       	jmp    80105d1e <alltraps>
...
80106755:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010675a:	e9 bf f5 ff ff       	jmp    80105d1e <alltraps>
...
80106761:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106766:	e9 b3 f5 ff ff       	jmp    80105d1e <alltraps>
...
8010676d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106772:	e9 a7 f5 ff ff       	jmp    80105d1e <alltraps>
...
80106779:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010677e:	e9 9b f5 ff ff       	jmp    80105d1e <alltraps>
...
80106785:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010678a:	e9 8f f5 ff ff       	jmp    80105d1e <alltraps>
...
80106791:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106796:	e9 83 f5 ff ff       	jmp    80105d1e <alltraps>
...
8010679d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801067a2:	e9 77 f5 ff ff       	jmp    80105d1e <alltraps>
...
801067a9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801067ae:	e9 6b f5 ff ff       	jmp    80105d1e <alltraps>
...
801067b5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801067ba:	e9 5f f5 ff ff       	jmp    80105d1e <alltraps>
...
801067c1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801067c6:	e9 53 f5 ff ff       	jmp    80105d1e <alltraps>
...
801067cd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801067d2:	e9 47 f5 ff ff       	jmp    80105d1e <alltraps>
...
801067d9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801067de:	e9 3b f5 ff ff       	jmp    80105d1e <alltraps>
...
801067e5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801067ea:	e9 2f f5 ff ff       	jmp    80105d1e <alltraps>
...
801067f1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801067f6:	e9 23 f5 ff ff       	jmp    80105d1e <alltraps>
...
801067fd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106802:	e9 17 f5 ff ff       	jmp    80105d1e <alltraps>
...
80106809:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010680e:	e9 0b f5 ff ff       	jmp    80105d1e <alltraps>
...
80106815:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010681a:	e9 ff f4 ff ff       	jmp    80105d1e <alltraps>
...
80106821:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106826:	e9 f3 f4 ff ff       	jmp    80105d1e <alltraps>
...
8010682d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106832:	e9 e7 f4 ff ff       	jmp    80105d1e <alltraps>
...
80106839:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010683e:	e9 db f4 ff ff       	jmp    80105d1e <alltraps>
...
80106845:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010684a:	e9 cf f4 ff ff       	jmp    80105d1e <alltraps>
...
80106851:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106856:	e9 c3 f4 ff ff       	jmp    80105d1e <alltraps>
...
8010685d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106862:	e9 b7 f4 ff ff       	jmp    80105d1e <alltraps>
...
80106869:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010686e:	e9 ab f4 ff ff       	jmp    80105d1e <alltraps>
...
80106875:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010687a:	e9 9f f4 ff ff       	jmp    80105d1e <alltraps>
...
80106881:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106886:	e9 93 f4 ff ff       	jmp    80105d1e <alltraps>
...
8010688d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106892:	e9 87 f4 ff ff       	jmp    80105d1e <alltraps>
...
80106899:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010689e:	e9 7b f4 ff ff       	jmp    80105d1e <alltraps>
...
801068a5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801068aa:	e9 6f f4 ff ff       	jmp    80105d1e <alltraps>
...
801068b1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801068b6:	e9 63 f4 ff ff       	jmp    80105d1e <alltraps>
...
801068bd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801068c2:	e9 57 f4 ff ff       	jmp    80105d1e <alltraps>
...
801068c9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801068ce:	e9 4b f4 ff ff       	jmp    80105d1e <alltraps>
...
801068d5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801068da:	e9 3f f4 ff ff       	jmp    80105d1e <alltraps>
...
801068e1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801068e6:	e9 33 f4 ff ff       	jmp    80105d1e <alltraps>
...
801068ed:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801068f2:	e9 27 f4 ff ff       	jmp    80105d1e <alltraps>
...
801068f9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801068fe:	e9 1b f4 ff ff       	jmp    80105d1e <alltraps>
...
80106905:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010690a:	e9 0f f4 ff ff       	jmp    80105d1e <alltraps>
...
80106911:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106916:	e9 03 f4 ff ff       	jmp    80105d1e <alltraps>
...
8010691d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106922:	e9 f7 f3 ff ff       	jmp    80105d1e <alltraps>
...
80106929:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010692e:	e9 eb f3 ff ff       	jmp    80105d1e <alltraps>
...
80106935:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010693a:	e9 df f3 ff ff       	jmp    80105d1e <alltraps>
...
80106941:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106946:	e9 d3 f3 ff ff       	jmp    80105d1e <alltraps>
...
8010694d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106952:	e9 c7 f3 ff ff       	jmp    80105d1e <alltraps>
...
80106959:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010695e:	e9 bb f3 ff ff       	jmp    80105d1e <alltraps>
...
80106965:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010696a:	e9 af f3 ff ff       	jmp    80105d1e <alltraps>
...
80106971:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106976:	e9 a3 f3 ff ff       	jmp    80105d1e <alltraps>
...
8010697d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106982:	e9 97 f3 ff ff       	jmp    80105d1e <alltraps>
...
80106989:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010698e:	e9 8b f3 ff ff       	jmp    80105d1e <alltraps>
...
80106995:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010699a:	e9 7f f3 ff ff       	jmp    80105d1e <alltraps>
...
801069a1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801069a6:	e9 73 f3 ff ff       	jmp    80105d1e <alltraps>
...
801069ad:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801069b2:	e9 67 f3 ff ff       	jmp    80105d1e <alltraps>
...
801069b9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801069be:	e9 5b f3 ff ff       	jmp    80105d1e <alltraps>
...
801069c5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801069ca:	e9 4f f3 ff ff       	jmp    80105d1e <alltraps>
...
801069d1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801069d6:	e9 43 f3 ff ff       	jmp    80105d1e <alltraps>
...
801069dd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801069e2:	e9 37 f3 ff ff       	jmp    80105d1e <alltraps>
...
801069e9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801069ee:	e9 2b f3 ff ff       	jmp    80105d1e <alltraps>
...
801069f5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801069fa:	e9 1f f3 ff ff       	jmp    80105d1e <alltraps>
...
80106a01:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106a06:	e9 13 f3 ff ff       	jmp    80105d1e <alltraps>
...
80106a0d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106a12:	e9 07 f3 ff ff       	jmp    80105d1e <alltraps>
...
80106a19:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106a1e:	e9 fb f2 ff ff       	jmp    80105d1e <alltraps>
...
80106a25:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106a2a:	e9 ef f2 ff ff       	jmp    80105d1e <alltraps>
...
80106a31:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106a36:	e9 e3 f2 ff ff       	jmp    80105d1e <alltraps>
...
80106a3d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106a42:	e9 d7 f2 ff ff       	jmp    80105d1e <alltraps>
...
80106a49:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106a4e:	e9 cb f2 ff ff       	jmp    80105d1e <alltraps>
...
80106a55:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106a5a:	e9 bf f2 ff ff       	jmp    80105d1e <alltraps>
...
80106a61:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106a66:	e9 b3 f2 ff ff       	jmp    80105d1e <alltraps>
...
80106a6d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106a72:	e9 a7 f2 ff ff       	jmp    80105d1e <alltraps>
...
80106a79:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106a7e:	e9 9b f2 ff ff       	jmp    80105d1e <alltraps>
...
80106a85:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106a8a:	e9 8f f2 ff ff       	jmp    80105d1e <alltraps>
...
80106a91:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106a96:	e9 83 f2 ff ff       	jmp    80105d1e <alltraps>
...
80106a9d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106aa2:	e9 77 f2 ff ff       	jmp    80105d1e <alltraps>
...
80106aa9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106aae:	e9 6b f2 ff ff       	jmp    80105d1e <alltraps>
...
80106ab5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106aba:	e9 5f f2 ff ff       	jmp    80105d1e <alltraps>
...
80106ac1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106ac6:	e9 53 f2 ff ff       	jmp    80105d1e <alltraps>
...
80106acd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106ad2:	e9 47 f2 ff ff       	jmp    80105d1e <alltraps>
...
80106ad9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106ade:	e9 3b f2 ff ff       	jmp    80105d1e <alltraps>
...
80106ae5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106aea:	e9 2f f2 ff ff       	jmp    80105d1e <alltraps>
...
80106af1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106af6:	e9 23 f2 ff ff       	jmp    80105d1e <alltraps>
...
80106afd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106b02:	e9 17 f2 ff ff       	jmp    80105d1e <alltraps>
...
80106b09:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106b0e:	e9 0b f2 ff ff       	jmp    80105d1e <alltraps>
...
80106b15:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106b1a:	e9 ff f1 ff ff       	jmp    80105d1e <alltraps>
...
80106b21:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106b26:	e9 f3 f1 ff ff       	jmp    80105d1e <alltraps>
...
80106b2d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106b32:	e9 e7 f1 ff ff       	jmp    80105d1e <alltraps>
...
80106b39:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106b3e:	e9 db f1 ff ff       	jmp    80105d1e <alltraps>
...
80106b45:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106b4a:	e9 cf f1 ff ff       	jmp    80105d1e <alltraps>
...
80106b51:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106b56:	e9 c3 f1 ff ff       	jmp    80105d1e <alltraps>
...
80106b5d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106b62:	e9 b7 f1 ff ff       	jmp    80105d1e <alltraps>
...
80106b69:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106b6e:	e9 ab f1 ff ff       	jmp    80105d1e <alltraps>
...
80106b75:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106b7a:	e9 9f f1 ff ff       	jmp    80105d1e <alltraps>
...
80106b81:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106b86:	e9 93 f1 ff ff       	jmp    80105d1e <alltraps>
...
80106b8d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106b92:	e9 87 f1 ff ff       	jmp    80105d1e <alltraps>
...
80106b99:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106b9e:	e9 7b f1 ff ff       	jmp    80105d1e <alltraps>
...
80106ba5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106baa:	e9 6f f1 ff ff       	jmp    80105d1e <alltraps>
...
80106bb1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106bb6:	e9 63 f1 ff ff       	jmp    80105d1e <alltraps>
...
80106bbd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106bc2:	e9 57 f1 ff ff       	jmp    80105d1e <alltraps>
...
80106bc9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106bce:	e9 4b f1 ff ff       	jmp    80105d1e <alltraps>
...
80106bd5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106bda:	e9 3f f1 ff ff       	jmp    80105d1e <alltraps>
...
80106be1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106be6:	e9 33 f1 ff ff       	jmp    80105d1e <alltraps>
...
80106bed:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106bf2:	e9 27 f1 ff ff       	jmp    80105d1e <alltraps>
...
80106bf9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106bfe:	e9 1b f1 ff ff       	jmp    80105d1e <alltraps>
...
80106c05:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106c0a:	e9 0f f1 ff ff       	jmp    80105d1e <alltraps>
...
80106c11:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106c16:	e9 03 f1 ff ff       	jmp    80105d1e <alltraps>
...
80106c1d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106c22:	e9 f7 f0 ff ff       	jmp    80105d1e <alltraps>
...
80106c29:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106c2e:	e9 eb f0 ff ff       	jmp    80105d1e <alltraps>
...
80106c35:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106c3a:	e9 df f0 ff ff       	jmp    80105d1e <alltraps>
...
80106c41:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106c46:	e9 d3 f0 ff ff       	jmp    80105d1e <alltraps>
...
80106c4d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106c52:	e9 c7 f0 ff ff       	jmp    80105d1e <alltraps>
...
80106c59:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106c5e:	e9 bb f0 ff ff       	jmp    80105d1e <alltraps>
...
80106c65:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106c6a:	e9 af f0 ff ff       	jmp    80105d1e <alltraps>
...
80106c71:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106c76:	e9 a3 f0 ff ff       	jmp    80105d1e <alltraps>
...
80106c7d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106c82:	e9 97 f0 ff ff       	jmp    80105d1e <alltraps>
...
80106dd5:	e8 c6 dc ff ff       	call   80104aa0 <memset>
...
80106e1d:	68 50 7f 10 80       	push   $0x80107f50
...
80106e33:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106e36:	e8 25 cb ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106ec0:	a1 c4 58 11 80       	mov    0x801158c4,%eax
...
80106ef4:	0f 84 c2 00 00 00    	je     80106fbc <switchuvm+0xec>
  pushcli();
80106efa:	e8 91 d9 ff ff       	call   80104890 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106eff:	e8 fc c9 ff ff       	call   80103900 <mycpu>
80106f04:	89 c3                	mov    %eax,%ebx
80106f06:	e8 f5 c9 ff ff       	call   80103900 <mycpu>
...
80106f18:	e8 e3 c9 ff ff       	call   80103900 <mycpu>
...
80106f61:	e8 9a c9 ff ff       	call   80103900 <mycpu>
...
80106f7f:	e8 7c c9 ff ff       	call   80103900 <mycpu>
80106f84:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106f87:	e8 74 c9 ff ff       	call   80103900 <mycpu>
...
8010700f:	e8 8c da ff ff       	call   80104aa0 <memset>
...
80107042:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107043:	e9 f8 da ff ff       	jmp    80104b40 <memmove>
    panic("inituvm: more than a page");
80107048:	83 ec 0c             	sub    $0xc,%esp
8010704b:	68 95 7f 10 80       	push   $0x80107f95
...
801070b0:	68 af 7f 10 80       	push   $0x80107faf
...
80107138:	68 50 80 10 80       	push   $0x80108050
...
8010719b:	e8 00 d9 ff ff       	call   80104aa0 <memset>
...
801071d9:	68 cd 7f 10 80       	push   $0x80107fcd
...
8010723b:	68 e5 7f 10 80       	push   $0x80107fe5
...
8010731c:	68 01 80 10 80       	push   $0x80108001
...
80107350:	e8 4b d7 ff ff       	call   80104aa0 <memset>
...
801073bb:	a3 c4 58 11 80       	mov    %eax,0x801158c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801073ec:	68 12 80 10 80       	push   $0x80108012
...
80107462:	68 1c 80 10 80       	push   $0x8010801c
...
801074c0:	e8 7b d6 ff ff       	call   80104b40 <memmove>
...
80107537:	68 36 80 10 80       	push   $0x80108036
